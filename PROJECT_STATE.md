...
## Current State — Task10 monthly Payment and Makeup naming; delivery in progress

**DEVELOPING / READY No / Task Done No.** Owner authorized the Payment lesson-month reader, bounded slip signing and existing child-name formatter, local disposable verification, normal publication and a new staged Production artifact. **Promotion and Resume are NOT authorized in this round:** submit the exact new artifact for Owner acceptance first. Production remains Paused; do not describe Kids booking as restored.

### Current Project Matrix

| Field | Current value |
| --- | --- |
| Active Task / Actor / Authorization | Task10 Payment monthly reads + Makeup child names + release readiness. Developer executes the latest Owner scope; supersedes the preceding proposed-Payment/awaiting-approval status and any unexecuted conditional Resume authority. |
| Task Status / READY / Task Done | DEVELOPING / No / No pending exact new staged authenticated smoke and Owner handoff. |
| Scope / Paths / Expansion / Breach | Functional5, tests4, test configuration1, Docs4 =14 planned/actual paths. No extra tracked dependency path, business expansion or scope breach. Temporary QA/delivery helpers and evidence stay outside Git/deployment. |
| Source Behavior | Payment uses booking lesson month at SQL level in Legacy inner relation, incomplete bookings and Progressive queue, before hydration/signing; Bangkok default, URL month/navigation and selected-month summaries. Stable range/chunk reads retain whole batch membership. Signing pool maximum4 per page preserves TTL/private Storage and propagates failures. |
| Naming / Protected Behavior | Makeup uses existing nickname - full-name formatter for exact child IDs in both tabs, full rosters, family cards, selector and destinations. Authorized family IDs only, bounded reads; self/profile names unchanged. No pricing, N/D/M, identity, source eligibility, replay, expiry, payment mutation, Wallet/Family, Attendance or Payroll rule changes. |
| Branch / Upstream | spike/next-major-security-upgrade / origin/spike/next-major-security-upgrade. |
| Git / Committed / Pushed | Gate0 and pre-publication HEAD/live remote9ccc2c288b2e62970de9a9818cf2382fac95fbb7,0/0,index empty. This containing source commit publishes the approved14 paths; exact commit/push/live read-back will be in private source-publication.json. No amend/force push. |
| Current Source / Source Complete | Five application files implemented; current candidate distinguished from Production1fba7bab987e8455824889563604063813e08855. Source publication and artifact checks remain delivery gates, not assumed from the old Owner PASS. |
| Fresh Verification | Full Task10 run85/86 initially; only new integration fixture failed because two synthetic creation timestamps tied and UUID order reversed payment prefix. Fixed fixture clock ordering, focused all-controls/real-worker integration PASS. Extended naming tests passed both tabs/search/full roster/identity/reload; final mobile capture check retained separately. History suite22/23 initially;621-batch UI passed after disposable image-origin binding. Six server-page signing/month/permission tests are part of those22, not an additional total. |
| Local Active Integration / Backend | Real disposable Booking on25September forOctober used late catalog700 then625 sibling accumulation; total1325 paid with accepted receipt, verified purchases satisfy D2/M2, Makeup uses one quota with exact source/attending identities and exact replay. All three flags and actual worker enabled together; one unpaid Adult bill cancelled once after its real local deadline, verified bills and historical purchase preserved. Raw live witness captured outside Git. |
| Failed / Bounded Evidence | Original month/signing red tests retained. Naming Review fixture initially hit booking guard; historical fixture seeding follows existing locked disposable convention and restores controls before commit, with equality assertion. Local HTTP Storage initially rejected by unchanged HTTPS Next image policy. First custom-server conf override did not reach Next16 dev router; second owned-export-only overlay worked. No guard/assertion weakened and no Production config change. Original failures retained. |
| Tests / Technical / Build | TypeScript, src lint, explicit changed-test/config lint and mojibake passed. Filtered365-file candidate real Production build exit0, BUILD_ID4uNYm8p3Sfxd6Sa_ySh95,24September17:04:55–17:05:36UTC. Content-bound pre-commit build, not relabelled as a later Git artifact. New staged exact-commit build/input/output proof still pending. |
| QA Runtime / Config Difference | Verified Task10Payment20260924 API61321/DB61322, exact containers/volume/workdir/network/Auth/REST/Storage. Browser/Auth/Node real time; existing business-clock mechanism only in disposable. Payment UI requires exact HTTP local Storage image binding in a temporary export-only config; repository deployment config unchanged, original export bytes restored and hashed. Actual image optimization and decoded image checked. |
| Retained Evidence | September22 Task1079/Booking23/Makeup5/Wallet45/Admin39/retrospective38 and preceding M6 Task1084/Wallet45 are retained when frozen bytes match, not fresh reruns or summed. Current Task10/History tests and Active integration are separately fresh. |
| Frozen / Migration Source / Applied |483 out-of-scope tracked files retain Gate0 raw hashes. M6 already applied:20260924133852_task10_rewallet_source_eligibility.sql SHA256a9904c31e96e27e8fd40b61f803da271ecea0f87ca01b2ddf52293a5c4c92990; deployed normalized body d85f879d754e0ffe81f8d2c5490f590b93f7082a505bf22c568d089c3dd1f591 verified fresh. New migration/apply0; M1–M6 unedited. |
| Deployed Source / Artifact / Routing | Production remains web1fba7bab987e8455824889563604063813e08855 / dpl_5bJmN6piCPmThycQEBSr9Rvqj2MF on four existing customer aliases. New Preview/staged will be recorded separately; no new artifact substitutes Production automatically. |
| Feature Enabled / Production Active / Scheduler | Fresh24September17:54:40UTC: Paused revision4, pricing/makeup/expiry false, cron single every-minute job inactive. Original effective_at2026-09-24T12:45:14.241075Z retained. Runs7/uses0/cohort0/receipts1/transition45. Kids new booking and Makeup consumption remain blocked; reads/payment compatibility governed by existing guards. |
| Environment / Permissions / Allowlist | No Production setting, secret, pool, permission, RLS, grant, allowlist, deployment protection, cron or routing changes. Local QA is explicitly separate. |
| Production Data Changed / Data Repaired / Financial Impact | No Developer Production business write, replay, cancellation, refund, repair or initial activation in this round. Prior28cancelled bills/104sessions remain protected;50,846THB is historical bill value, not a new refund/loss. Do not claim all customer traffic or accounting was frozen/audited. Fresh post-delivery exact comparisons remain required. |
| Owner Acceptance / UAT | Previous PM-operated QA accepted by Owner is historical. New artifact Owner acceptance Pending. Local Active functional QA is not staged read-only QA, and neither is Production business UAT. |
| Promotion / Resume / Recovery | Not executed and not authorized now. After separate Owner approval: exact staged Promotion without rebuild, fresh Paused Production smoke/revision/deadline evidence, existing Resume preserving effective_at, then natural workers and postchecks. Pause blocks new Kids service; it is not service restoration or data rollback. No incompatible old-artifact rollback. |
| Blocker / Remaining Work / Next Gate | Finish final evidence and normal source publication; verify automatic Preview, create exact staged Production with --prod --skip-domain, authenticated school-role Payment/Makeup/pricing/login/assets and scoped logs, then Owner review. Never use anonymous200/one successful reload as privileged/intermittent-error PASS. |
| Documentation Drift / Unknowns | Replaced old awaiting Payment approval/current unresolved-source claims with authorized implementation and actual verification. Preserve prior cutover/Resume/safetyPause, packaging/exposure and failed-test history. Historical stream-close/ERR_ABORTED, credential validity/exposure and total Storage-pressure contribution remain Unknown; no systemwide security/Production PASS. |
| Parking Lot | No other task authorized; do not start automatically. |

Private evidence root: C:/Users/aacha/AppData/Local/Temp/task10-calendar-uat-20260922/payment-monthly-readiness-20260924T163500Z. Raw rows, accounts, signed links, screenshots, logs, helper registration/hashes and failed/passed runs remain outside Git/deployment. See [Owner scope](AGENTS.md#task10-payment-monthly-naming-decision-2026-09-25) and [dated verification](DEVELOPMENT_TODO.md#task10-payment-monthly-naming-2026-09-25). Current publication/artifact results will be closed out separately from application SHA; no deployment loop for docs-only commits.
