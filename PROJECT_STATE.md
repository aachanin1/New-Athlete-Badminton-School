...
Last updated: 2026-09-24 (Asia/Bangkok; evidence timestamps UTC)

## Current State — Task10 cutover committed; paused after Production Makeup failure

**Cutover cancellation Complete; activation readiness Blocked.** Owner authorized the one-time no-payment/no-slip cancellation and activation. The exact transaction committed at **19:45:14.241075 Asia/Bangkok on 2026-09-24**, then authenticated Makeup failed with `TASK10_AMBIGUOUS_SOURCE`. The authorized safety pause committed at **19:49:29.842503**. Current state is **paused / revision2 / three flags OFF / cron inactive**. The28cancelled bills remain cancelled. **DEVELOPING; READY No; Task Done No.**

### Current Project Matrix

| Field | Current value |
| --- | --- |
| Active Task / Intended Behavior | Task10 — Owner-directed one-time unpaid-bill cutover, activation and postchecks. Cancellation completed; resolve the newly exposed Makeup read defect before any resume. |
| Task Status / Task Done / READY | DEVELOPING / No / No. Production authenticated Makeup required smoke FAILED; safe handoff published with this Docs4 closeout. |
| Owner Decision / Actor | Owner's2026-09-24 command explicitly authorized exact-row cancellation of pre-cutover pending_payment bills with no payment/slip evidence, both overdue and future, then activation; deadline23:59Bangkok. Developer Codex executed via DB-owner connector under the confirmed real school SuperAdmin authority. Audits distinguish Owner direction from customer action. Same command authorized pause on attributable regression. Source/schema correction and resume of defective behavior are not authorized by this handoff. |
| Changed Paths / Scope / Breach | Functional0 / Tests0 / Docs4 / Config0 / Dependencies0 / Migrations0. AGENTS.md, PROJECT_STATE.md, TODO-CODEX.md, DEVELOPMENT_TODO.md only. Owner explicitly expanded Docs3 toDocs4 for this business exception; unapproved expansion0/breach0. New local helpers/evidence outsideGit only; historical packaging/exposure breach remains recorded. |
| Blast Radius / Protected Behavior | Authorized Production cancellation, activation evidence/controls/cron, then safety pause. Existing transactional functions only; no runtime source, business formula, permission or schema change. Verified purchases, Family identities, Wallet expiry, quota, payments, attendance and payroll remain protected. |
| Branch / Upstream | spike/next-major-security-upgrade / origin/spike/next-major-security-upgrade. |
| Local HEAD / Remote HEAD / Ahead-Behind | Gate0 and fresh pre-write12:38UTC both6f9d6d30fbb132880c87043235b982361931f05b, live verified0/0, clean/emptyindex. This containing Docs4 successor is separate from application SHA; final commit/live equality/clean proof is in owner-cutover-20260924T115900Z/publication.json. |
| Index / Worktree / Docs Commit | Only authorizedDocs4 changed from clean baseline; complete staged diff, privacy, encoding and consistency checked before normal commit/push. Final clean state and automatic Docs Preview recorded separately, never substituted for Production artifact. |
| Source Complete / Current Source / Pushed Source | Accepted corrective source remains1fba7bab987e8455824889563604063813e08855, committed/pushed.489non-Docs4 tracked paths and accepted protected/corrective hashes match. New Production read defect remains unfixed; overall completion is not claimed. |
| Tests Passed / Fresh vs Retained | Fresh15focused disposable checks passed: cancellation past/future/allflows, payment/slip protection/race, rollback, replay/conflict, coupon/capacity/Legacy baseline, old-policy booking race, late receipt rejection and new late pricing. Fresh19post-cancellation reconciliation checks passed. Required Production Makeup smoke FAILED. Retained22September Task1079/79,Booking23/23,Makeup5/5,Wallet45/45,Admin39/39,retrospective38/38 plus TypeScript/lint/build remain old results, not summed or rerun. |
| Fresh Identity / Definitions | Production project tvnhholicwjtxdhlxfqs/PG17.6 ACTIVE_HEALTHY binding verified. M1–M5 applied5, rawfile hashes and88deployed bodies match; cancellation dependencies separately verified. Real actor verified from authorized identity, not chosen randomly. No grants/Auth change or actor impersonation. |
| Exact Cutover Manifest | Fresh12:33UTC snapshot:28bills/27holders/104participant-sessionrows/82slots,50,846THB bill amount;22overdue+6future.16ProgressiveKids/2LegacyKids/7LegacyAdult/3LegacyPrivate.1prepared batch without slip cancelled. Payment/receipt/allocation/coupon evidence absent for selected rows; owner storage and multipart metadata reviewed. PM reference27 differs+1; exact PM ID/time differenceUnknown. Private manifest contains exact rows and fixed requests. |
| Atomicity / Execution | Policy and booking locks plus NOWAIT evidence locks, exact snapshot comparison, payment recheck, existing flow-specific cancellation RPCs, post-cancel canonical manifest comparison and activation in one transaction. Progressive newest-first before Legacy. Owner-directed audit preserves real operator; new uncommitted RPC audit attribution corrected without changing historical logs or immutable owner replay identity. No Production rehearsal. |
| Production Cancellation / Protected Rows |28bills nowcancelled,104sessions soft-cancelled with identities/links/pricing unchanged; session status cache unchanged.1255paid/verified bills protected by equal row hash; Wallet and Attendance hashes equal.12Legacy cancellation records,16Progressive cancellation receipts,46operation audit rows. No selected coupon reservations; no protected adjacent residue. No customer rebooking/message, refund, uncancellation or repair. |
| Baseline / Capacity / Financial Evidence |82slot counts match live eligible occupancy;16scope Legacy baselines match and remain0 in these actual scopes; no baseline delta required. Payments620,allocations637,couponusages0,finance_expenses7,payrollsummaries13,Walletmembers163,Task10Makeupuses0 aggregate hashes equal at compared snapshots. This is bounded evidence, not whole-system financial certification or a claim that customer traffic was frozen.50,846THB is cancelled bill value, not refunded cash or automatic revenue loss. |
| Activation Manifest / Actual Effects | Actual post-cancel fingerprint049b8107c5fcf6f9c26285234cacc2b4f86e3508ba3e41b541638650d34608c9.45exact Wallettransition rows inserted;0old-billcohort/0acceptedreceipts; activationevent1. Original assessment52row plan was not reused. Transition evidence does not extend stored expiry, revive credits or grant45uses. |
| Feature Enabled / Activation / Scheduler | Activation committed12:45:14.241075UTC (19:45:14Bangkok), revision1/3flagsON/cronactive. Authorized pause committed12:49:29.842503UTC, revision2/3flagsOFF/croninactive; effective_at and acceptedartifact retained.4natural worker runs complete, cancelled0/failures0; no manual worker. Active-window newbookings0/payments0/Task10Makeupuses0. |
| Production Active / Customer Impact | Accepted web artifact remains customerProduction active. Activation-gated Task10 is PAUSED, not never_activated. New Kids booking and new family Makeup are blocked by existing pause guards; expiry scheduler is stopped. Admin Makeup continues to fail because effective_at remains set and the family read path still executes. Other checked homepage/pricing/payment reads remain accessible. Customers cannot yet be told Task10 is ready. |
| Root Cause / Blocker | M3 task10_family_makeup_state_v1 checks duplicate canonical roots before testing whether each candidate is still eligible. In2confirmed families, valid redeemed-original→active-rewalleted-descendant history sorts with descendant first; later spent original throws TASK10_AMBIGUOUS_SOURCE. Source graph is structurally consistent and no duplicate unusedcredit found in bounded217Septemberfamilies/292seeds. Admin page Promise.all propagates the exception to the whole page. No data repair is warranted from this evidence. |
| Proposed Correction / Remaining Work | Owner decision required for one new additive migration replacing only that state reader: test duplicate roots inside existing eligible-kind block, preserving fail-closed for genuinely duplicate eligible sources. Add focused re-wallet/UUID-order/paused-read/true-duplicate/replay regression in tests/task10-regression/task10-transactions.spec.ts. Do not edit applied M3 history, clear effective_at, bypass guards or repair rows. Prove correction in disposable, review exact deployed diff and separately gate resume. No guarantee of23:59 readiness while blocked. |
| Catalog / M | Existing early/late catalogrevision1 and M2/revision1 retained. Rates700/625/500/433/406/350; distinct tier boundaries/formulas unchanged. Local post-activation late-pricing test preserved4paidLegacy entitlement and charged2new sessions at433=866. No Production booking/pricing-save trial. Paused pricing UI truthfully shows catalog sets inactive for new booking. |
| Owner Acceptance / Production UAT | Prior Owner acceptance PASS remains PM-operated temporary-exception QA for accepted bytes, not Owner clicks or Production business UAT. This round's15Developer local checks are separate. Production business UAT Passed No; read-only Makeup smoke failed after real authorized cutover. |
| Local Environment / Preservation | New verified Developer-owned Task10Cutover20260924 API59321/DB59322 used existing harness/migrations for synthetic checks. Actual container/volume/workdir/network/Auth/REST/Storage verified. Its successful local commit remains as evidence; no cleanup. Owner PM/UAT54321/55321/56321/57321/58321 were not reset/reseeded/replayed/stopped. Retained Owner buildPXUCkAh-yTw4DI3U0jEs3/3050servingNo from prior read; not restarted or rebuilt here. |
| Artifact / Deployed Source | dpl_5bJmN6piCPmThycQEBSr9Rvqj2MF /1fba7bab987e8455824889563604063813e08855,READY,targetproduction. Creation/build/ready timestamps unchanged. No rebuild/redeploy/replacement/Promotion this round. |
| Routing / Health / Logs | Fresh12:56UTC all4customeraliases stillacceptedartifact; www.newathleteschool.com health200/ok,home200,login200; anonymous booking/payment307toauth. School-role pricing/payment reads load. Scoped12:44–12:57:05UTC logs:3Makeup error requests matching digest569581647, fatal0/5xx0. HTTP200streamed response did not mean renderPASS. MCPlogs internalerror preserved; installedCLI filteredreads succeeded without policy bypass; unfiltered100row cap not treated complete. |
| Pause / Rollback | Current acceptedartifact paused using existing revision-checked RPC. No oldartifact rollback;99b70/Gwx4 is not proven compatible afteractivation. Pause preserves cancellation, evidence, quota/history and financial effects; it does not refund, restore bills/credits or fix the Makeup read error. |
| Migration / Environment / Allowlist | M1–M5 alreadyapplied and freshly verified; no remote migration/apply/repair or definitionedit. Environment/secrets/roles/permissions/allowlist/protection unchanged. Clock/Auth realtime; no Production clockoverride or trialactivate/rollback. |
| Production Data Changed / Data Repaired | Yes: authorized exact cancellation/audits/transition/activation+pause/events/cron plus natural worker-run evidence. Data Repaired No. No extra customer test transactions, deletion or financial repair. |
| Documentation Drift / Scope Expansion / Breach | Old current-state activationNOTAUTHORIZED/OFF snapshot superseded by latest explicit authorization and actual active→paused result. Docs4 records the one-time exception; no hidden failure or sourcefix. ScopeExpansion0beyondOwnercontract/Breach0. Historical records preserved; rawrows/credentials/accounts remain outsideGit/deployment. |
| Unknowns / Limitations | Old stream-close/ERR_ABORTED,credentialvalidity/historicalexposure and oldfinancialbaseline Unknowns remain. Exact PM27row differenceUnknown. No wholeProduction/securityPASS. No accepted new fix/migration or successful post-activation Makeup UI. Active-window counts and compared hashes do not certify all future/customer activity. |
| Next Gate / Parking Lot | Owner reviews narrow migration/regression correction; only then implementation/verification and separately controlled resume. Never replay cancellation or original activate. Task10 only; ParkingLot1–8unselected/9completed unchanged. Task Done No. |

Private evidence: C:/Users/aacha/AppData/Local/Temp/task10-calendar-uat-20260922/owner-cutover-20260924T115900Z — SAFE-HANDOFF.md, CUTOVER-PLAN.md, production-plan-private.json, developer-post-reconciliation.json, paused-exact-private.json, affected-chain-private.json, browser-postchecks.json, filtered-log-proof.json, publication.json and evidence-index.json. Exact IDs, names, receipt metadata and accounts remain private.
[One-time policy](AGENTS.md#task10-one-time-cutover-decision-2026-09-24). [Dated cutover and safety pause](DEVELOPMENT_TODO.md#task10-owner-cutover-paused-2026-09-24). Prior PM/Owner acceptance, Promotion, assessment and post-UAT history remain preserved.
...
- Expand Parking Lot **8 — ความถูกต้องของการมอบหมายโค้ช — สถานะ ผู้รับผิดชอบ ประวัติ และการบันทึก**,
  ...
  Keep both numbers; item 5 remains **unresolved**, with no common-cause or fix claim.
- Assignment status: **PARKING LOT — OWNER SELECTION REQUIRED; NOT AUTHORIZED TO START**.
  Withdraw the earlier proposal to pause Task10 or start an assignment hotfix first.
  Task10 completion does not automatically start assignment work: separate Owner
  selection and a newly audited development Scope Contract are required.
- Family Wallet/history finding: **pending revalidation after Task10** against
  then-current Source, tests, schema and actual enabled/deployed state. Neither
  a continuing defect nor a complete Task10 fix is assumed without evidence.
- [Dated plan, PM evidence limits and future acceptance](DEVELOPMENT_TODO.md#coach-assignment-correctness-plan-2026-09-13);
  [queue item 8](TODO-CODEX.md#coach-assignment-parking-lot-8).
  PM's 2026-09-13 coach Belle / NA เทพารักษ์ findings are supplied historical
  evidence, not new queries or Product tests in this documentation round.
- This approval is **local documentation update only**, exact
  Functional/Test/Documentation/Config/Migration **0/0/3/0/0**. No stage, commit,
  push, deploy, promote, implementation, fixtures, Product tests/UAT, controls,
...
Developer completed that Promotion, fresh Production checks and SELECT-only UAT
reconciliation. This closeout is published by its containing documentation commit;
exact commit/remote equality and final unchanged Production identity are recorded
in publication evidence. No task from the remaining queue starts automatically.
...
| Task Status / Task Done | **Task 9: TASK DONE / Yes**, with exact Promotion, Production verification and this authorized closeout publication |
| Completed Task / Intended Behavior | **9 — BRANCH PAYMENT ACCOUNTS — BOOKING-RELEVANT DISPLAY & COPY**. Admin/Super Admin with payments permission manages accounts; User sees every relevant booking/session branch, identical bank/number cards merge, copy number/details, whole combined total into one displayed account with one slip. No primary or recorded account selection |
| Scope / Blast Radius | This closeout **Functional/Test/Documentation 0/0/3**: PROJECT_STATE.md, TODO-CODEX.md, DEVELOPMENT_TODO.md only. Cumulative **10/3/4**. Exact Owner-PASS artifact promoted to the three existing Production aliases; no new business flow |
| Protected Flows | Pricing/coupons/totals/entitlement, Legacy grouping, Progressive full pending scope and payment lifecycle, shared SlipOK mode, historical recipients, Ledger/Finance/Wallet/Attendance/Payroll and permissions unchanged |
...
| Local HEAD / Remote HEAD / Ahead-Behind | Gate 0 fresh fetch: **63bb183f8bbc346bead3c2b796531c52e198bc54 / same / 0/0**, clean and staged empty. This containing closeout commit is the documentation-only successor; exact final SHA and remote equality are recorded in the publication report, avoiding recursive self-reference |
| Worktree / Staged | Only three allowed closeout docs changed; complete staged diff/name-status/stat/check and consistency matrix reviewed before commit. Clean/staged-empty after normal push is verified in final evidence |
| Current Source / Pushed Source / Application SHA | **99b70fe373bfaa14424e2163136719024e5f0b0b / same**. src tree **87049830fbf14fb48ceb4b166f18b32d47d34c82**. All 13 tested Source/Test hashes match; changes after application SHA are documentation only |
| Source Complete | **Yes**; no functional/test correction in this release round |
| Tests Passed | **Yes**. Retained, hash-bound History **16/16**, focused **19/19**, Batch **44/44**, Integration **29/29**, SlipOK **6/6**, TypeScript/lint/mojibake/Production build. No rebuild or disposable reset repeated. Fresh Production smoke, scoped logs, exact identity/config checks and documentation mojibake/diff/matrix passed |
| Committed / Pushed | **Yes / Yes** for application 99b70fe373bfaa14424e2163136719024e5f0b0b; this containing documentation-only closeout commit is separately normal-pushed and verified |
| Deployed / Promoted Artifact | **Yes / dpl_Gwx4XuRureXfQh4vhCUxPEtHECBa**, target production, **READY / PROMOTED**, Application SHA **99b70fe373bfaa14424e2163136719024e5f0b0b** |
| Artifact URL / Production URL | https://new-athlete-badminton-school-llo19jlt9-aachanin1s-projects.vercel.app / **https://www.newathleteschool.com** |
| Promotion / Rebuild / Replacement Deployment | **Completed 2026-09-08 04:35:41–04:35:47 UTC (11:35:41–11:35:47 Bangkok) / No / No Production replacement**. One CLI promote of exact ID, exit 0. Created/building/ready timestamps and source metadata unchanged; no deployment created during Promotion. Documentation push may trigger a separate Preview, never used as the promoted artifact |
| Production Aliases | **www.newathleteschool.com**, **new-athlete-badminton-school.vercel.app**, **new-athlete-badminton-school-aachanin1s-projects.vercel.app** all verified against the exact promoted ID. Git productionBranch remains **main**; closeout spike-branch push cannot promote its Preview |
| Rollback Candidate | **dpl_CU1J3Vurx6JZby9oQtLqnNhcDaRc**, SHA **7f27864cd100d860644c1e20c75b170ac0cb0986**. Fresh READY and prior alias identity/health 200 verified before Promotion; no rollback or data reversal performed |
| Owner Staged UAT | **PASS**, exact ID/Application SHA above. Owner reported three screenshots and confirmed **“เปิดดู/คัดลอก ไม่กดบันทึกหรือส่งสลิป”**. This acceptance is separate from the backend-recorded booking/batch actions below |
| Production Active / Feature Behavior Active | **Yes / Yes**, receiving-account display/copy on the exact promoted source; current accounts are instructions, not proof of historical/live-verified recipients |
| Production Automated Checks | **Passed fresh**: two public aliases health 200/ok; third existing protected alias health 200 through temporary Vercel access (anonymous 302 to Vercel). Homepage/login and 21 exact-artifact assets 200; Admin API anonymous 401; protected Admin/History pages 307 to correct login routes. No application login/prepare/upload/save used for smoke |
| Production Scoped Logs | Deployment-scoped **error/fatal and 5xx queries returned no entries**, from 04:35:47 UTC after Promotion through the checked window. No task-attributable regression observed; this is bounded evidence, not a promise about future traffic |
| Production Manual UAT / Production UAT Passed | **Not repeated / No separate manual Production PASS claimed**. Owner staged PASS and fresh automated Production checks apply to the unchanged exact artifact; no repeat requested |
| Controlled Write UAT | Prior Developer disposable API/DB tests **passed**. During Owner UAT, real booking create/edit/cancel and batch prepare/cancel records were independently reconciled read-only; no slip/payment/approval found. No Developer Production writes or repair |
| Effective Account Configuration | **Source defaults: 8 accounts / 12 exact active branches**. payment_transfer_settings remains legacy singleton, accountNumber 0000000000, instructions TEST Mode, other fields blank, updated_at **2026-05-18T12:24:00.995606+00:00**. No saved collection or settings-save audit since staging; before/after Promotion value and roster identical |
| Defaults Fingerprint / Configuration Gate | **29036b3d1131efbc2b5cbecb1934b9c9cba32f31b94170ed4671ce3cea42f7f6** matches actual normalizer, original roster and artifact metadata. Both confirmed aliases unchanged. Tracked config unchanged; Production environment metadata predates staged build; no secret values exposed or changed |
| UAT Matched Rows / Timeline | Bookings **0717c0fb-20cb-4405-aecb-1c8b3ebc4088** and **437fe762-3047-448f-8353-72961e9e705d** are cancelled. Named batches **4387f611-a869-4d7a-be8f-e50c07444938 / 1,250** and **252e56c9-6fa8-48c6-8647-5c6cd89d3d40 / 1,875** are cancelled. Second booking later edited at **04:19:31 UTC** to 1 session/700; two later 700 batches also cancelled. Old 1,875 snapshot is not compared with later 700 state as a UI defect |
| UAT Financial/Lock Result | All **4** related batch memberships inactive; scope **1f96600e-d7f5-4da4-970c-94246701e05d**, revision 9, locked_by_payment_batch_id/locked_at null. All batches have no slip/upload/submission/review/approval; matched payments, payment slips, verification attempts and allocations **0**. Full queried booking/batch/member/scope/audit values unchanged across Promotion |
| Developer Production Writes / Owner-period Data Changes | **No / Yes**. Developer did SELECT/health reads and infrastructure alias Promotion only. Backend records two booking creations, one later edit, two booking cancellations and four batch prepare/cancel pairs during Owner UAT. Do not infer no data changes from no settings save or no slip upload |
| Production Data Changed / Payment Settings Changed / Data Repaired | **Yes during Owner UAT / No / No**. Promotion itself did not change the reconciled application rows. No cleanup, cancellation, unlock, migration or financial repair by Developer |
| Host Runtime Changed | **No this round**: no Docker/WSL/startup/directory/backup action, no local reset/fixtures. Prior authorized recovery, B physical-target deviation/restoration and disposable cleanup remain in dated history |
| Application / Production Environment | **No changes this round**; immutable staged build retained. Prior local npx/Supabase setup effects are historical, not new release actions |
| Migration Source / Migration Applied | **No source change / No application or Production migration this round**; earlier 35 existing migrations were applied only to disposable tests |
| Dependencies / Lockfile / Permissions | **No changes / No changes / No changes** |
| Feature-control Changes / Allowlisted | **None / No changes**. Feature behavior is active through source Promotion; no new feature flag, allowlist or shared SlipOK-mode change |
| Fixtures / Cleanup | **No new fixtures or cleanup this round**. Retained disposable evidence: DB/API/new physical residue 0, original 88/88 storage files preserved. Production UAT history retained intact |
| Customer Impact | Customers now see relevant branch accounts, merged shared cards, bank colors and truthful copy/manual fallback; Admin manages branch bindings with stale-save protection |
| Financial Impact | Receiving instructions changed; pricing/combined amounts/payment lifecycle and financial history did not. UAT booking quantities/prices changed through recorded create/edit/cancel actions; no settled payment, receipt, approval or allocation in matched cases |
| Scope Expansion / Scope Breach / Corrections | **None this round / None this round / No application correction**. Only bounded read-only verification helper adjustments; earlier host physical-target deviation remains historical and is not hidden |
| Documentation Drift | **Resolved**: READY/waiting-for-PASS and no-Owner-transaction statements superseded by explicit Owner PASS, exact Promotion and fresh backend chronology. Registration, implementation, Docker and prior handoffs preserved |
| Blocker / Remaining Work | **None for task 9**. Required technical/release/data reconciliation and closeout publication complete; no follow-up product work inferred |
| Next Gate / Next Action | **Await Owner selection of another task**; do not start Parking Lot 1–8 automatically |
| Parking Lot Authorization State | Original **1–8** retain order and remain unauthorized. Original **9** is completed and preserved as history, not a new queue entry |

Remaining Owner-selection queue — original positions retained:
...
Original item **9 — BRANCH PAYMENT ACCOUNTS — BOOKING-RELEVANT DISPLAY & COPY** is
completed. Exact 10/3/4 paths, accounts/mapping and earlier evidence remain in
DEVELOPMENT_TODO.md. Latest release record: **2026-09-08 — Task 9 Owner PASS,
exact Promotion, Production verification and closeout**.

## Historical / Superseded — Branch payment accounts Parking Lot registration

State observed at the earlier documentation-only registration. All selection,
destination, Git, queue and next-action statements in this historical section
are scoped to that registration and superseded by the first matrix above.
...
PROJECT_STATE.md is the sole authority for current mutable state. Owner's latest
2026-09-07 command explicitly confirms staged UAT PASS for this exact artifact,
references the conversation's supporting images and supersedes the earlier
PASS-pending handoff. Images are UI evidence; no business write is inferred.

### Current Project Matrix

| Field | Current value |
| --- | --- |
| Active Task | **None — Awaiting Owner Selection**; completed: **LV 0 — SHARED LEARNER LABEL & RED VISIBILITY ACROSS PORTALS / exact-artifact Promotion & closeout** |
| Task Status / Task Done | **TASK DONE / Yes**, after exact Promotion, required Production checks and documentation publication |
| Intended Behavior / Actor | Developer released the Owner-tested **LV 0 · นักเรียนใหม่/รอประเมิน**, red/bold/readable at the approved existing learner labels across nine pages, preserving other behavior |
| Blast radius / Changed files | Production domains now use the passed LV 0 artifact. This Promotion round: **Functional 0 / Tests 0 / Dependency 0 / Config 0 / Migration 0 / Documentation 3**: PROJECT_STATE.md, TODO-CODEX.md, DEVELOPMENT_TODO.md |
| Root Cause / Corrections | Original duplicate/gray/fallback label and named-Level precedence were fixed in the existing tested source. This round changed no application behavior. Read-only smoke harness used existing automation access for two SSO-protected Vercel aliases; no protection change |
| Branch / Upstream | spike/next-major-security-upgrade / origin/spike/next-major-security-upgrade; unchanged |
| Local HEAD | Documentation closeout commit containing this matrix; parent **17861433334e3a9cfd1d79e2df12f533ccb3ef06**. Exact documentation SHA recorded in final report and excluded promotion-final-publication.json, avoiding recursive self-reference |
| Remote HEAD / Ahead-Behind | Same documentation closeout revision after verified normal push / **0/0** in promotion-final-publication.json. Fresh pre-Promotion remote matched parent HEAD above |
| Worktree / Staged | **Clean / empty after closeout publication**, verified in promotion-final-publication.json; fresh Gate 0 was also clean |
| Current Source / Pushed Source | **7f27864cd100d860644c1e20c75b170ac0cb0986**, application tree **0d91b10ea1eac0125e8af9d13d7ff3ab3aed15b3**; later commits change only the three approved docs, not application/test/config/dependency bytes |
| Source Complete | **Yes**; unchanged Owner-passed implementation, no source edits this round |
| Tests Passed | **Yes — retained same-source evidence**: TypeScript, lint 0 warnings, mojibake, Production build 94/94, focused LV 0, schedule 17, assignment 39, resolution 33, lifecycle source-only 42, component fixtures 27/27 at 320/390/1440px, diff. Fresh Production health/browser/identity/error queries passed. No build or fixture rerun for Promotion |
| Verification limitations | **Authenticated DB E2E not run**; original Docker/disposable-DB limitation remains. Component fixtures 27/27 and fallback/dialog/Family tests are local evidence. Owner manual staged UAT is **PASS**, not an automated DB E2E claim |
| Committed / Pushed | **Yes / Yes** — existing application and normal documentation-only closeout; exact publication evidence retained separately |
| Deployed / Artifact ID | **Yes — existing artifact dpl_CU1J3Vurx6JZby9oQtLqnNhcDaRc, production/READY/PROMOTED**; no new deployment, rebuild or replacement command |
| Artifact immutable URL | https://new-athlete-badminton-school-m6d17uus9-aachanin1s-projects.vercel.app |
| Deployed Source / Artifact Tree | **7f27864cd100d860644c1e20c75b170ac0cb0986 / 0d91b10ea1eac0125e8af9d13d7ff3ab3aed15b3** |
| Dependency lock | SHA256 **ad252f85dfaaf55dc58638b71860db672488b5669bc254b9c82909ffe8838dda**; actual deployed bytes downloaded read-only and matched, unchanged locally |
| Owner UAT | **PASS** — latest Owner command records “ผมว่าผ่านแล้วครับผม” with referenced conversation images for this exact ID/SHA/tree/URL; no new PASS requested |
| Promotion | **Yes** — one exact promote command, **2026-09-07T04:39:43.691Z–2026-09-07T04:39:50.244Z**, exit **0**; 11:39:50 Asia/Bangkok completion |
| No-rebuild continuity | **404/404 uploaded raw file hashes**, **15/15 tested fingerprints**, deployed lock, ID/SHA/tree/URL all matched before/after; createdAt **1788754580297**, buildingAt **1788754581275**, ready **1788754658200** unchanged. Deploy/rebuild/redeploy/rollback/manual-alias commands **0** |
| Production Active / Deployment ID | **Yes — LV 0 artifact dpl_CU1J3Vurx6JZby9oQtLqnNhcDaRc** at https://www.newathleteschool.com |
| Production aliases | All four point to the exact passed artifact: new-athlete-badminton-school-aachanin1-aachanin1s-projects.vercel.app; new-athlete-badminton-school-aachanin1s-projects.vercel.app; new-athlete-badminton-school.vercel.app; www.newathleteschool.com |
| Production health / Browser | Fresh **2026-09-07T04:43:29.587Z–2026-09-07T04:43:57.087Z**: root/health/Login/Ranking 200 on four aliases and immutable URL; eight protected scoped routes 307 to correct Login; **68** distinct static URLs across Production/immutable, no page/console/hydration/static errors or browser write requests. Public LV 0 child/adult 15 visible badges per tab at 390/1440px red rgb(185,28,28), weight 700, 14px, no clipping; search/filter passed. Assessed names/levels/labels/colors matched immutable for 15 rows per tab |
| Production logs | Exact deployment, **2026-09-07T04:39:50Z–2026-09-07T04:44:10Z**: dedicated error/fatal query **0**, 5xx query **0**. CLI repeated 50 unique request IDs up to its 1000-row limit; grouped API reports top values only, so no exhaustive request-total claim. Raw/filtered evidence retained; bounded window, not an indefinite no-error guarantee |
| Rollback candidate | **dpl_G9Lg59UdXZ8LSVkBYjYfwVmMJxPq**, READY, https://new-athlete-badminton-school-89vusndmx-aachanin1s-projects.vercel.app; verified before Promotion with root/health/Login 200 and same security lock. Retained READY afterward; no rollback executed or implicitly authorized |
| Production UAT Passed / Manual Production UAT | Owner manual **staged PASS**; manual Production UAT **not rerun**, as authorized. Fresh automated Production checks passed with unchanged exact artifact |
| Feature Enabled / Allowlisted | LV 0 presentation **Production active** through Promotion; **no feature-control or allowlist changes**, no new flag |
| Environment / Secrets / Settings / Protection | **No changes**; existing automation credential used in memory only for existing protected Vercel hosts. Public www and canonical vercel.app checked anonymously |
| Migration Source / Migration Applied | **No change / No action** |
| Controlled Write UAT | **Not run** |
| Production Data Changed / Data Repaired | **No / No** task-attributable business writes; no database reset, fixtures, assessment/group/Attendance/Booking/Wallet/financial operation |
| Customer Impact / Financial Impact | Approved LV 0 wording/visibility now live across the passed artifact's scoped portals; **no financial mutation**, additional charge **0 บาท** |
| Scope Expansion / Scope Breach | **None / None**; protected flows, source, tests, dependencies, config and permissions untouched in this round |
| Documentation Drift | **Resolved**: prior PASS-pending/Production-inactive handoff replaced in current state; dated implementation/UAT/security/registration histories retained. TODO derives the completed status from this matrix |
| Blocker / Remaining Work | **None / None for LV 0**; no required second manual Production UAT |
| Next Gate / Next Action | **Wait for Owner to select the next task**. Parking Lot items 1–7 remain unselected and unauthorized to start |
| Parking Lot authorization state | Exactly **seven**, original items 1–7 in unchanged order; former item 8 **completed**, not Active or unselected |

Detailed dated Promotion evidence: DEVELOPMENT_TODO.md, **2026-09-07 LV 0 exact-artifact
Promotion closeout**. Raw evidence remains excluded under .playwright/lv0/;
no credentials, screenshots, fixtures or logs were added to Git/deployment input.

## Historical / Superseded — 2026-09-07 Production dependency security closeout

State observed at that completed closeout. The current LV 0 matrix above supersedes
its Active Task, next selection, Git/worktree and Parking Lot authorization facts.

Status: **TASK DONE — EXACT ARTIFACT PROMOTED AND VERIFIED**.

PROJECT_STATE.md is authoritative for current mutable state. Owner PASS dated
2026-09-07 authorized Promotion of the exact previously tested Production
artifact without rebuild and documentation-only closeout. The completed Makeup
history and all eight unselected Parking Lot items are preserved.

### Current Project Matrix

| Field | Current value |
| --- | --- |
| Active Task | **None — Awaiting Owner Selection**; completed: ตรวจและแก้ช่องโหว่แพ็กเกจที่กระทบ Production |
| Task Status | **TASK DONE — exact Owner-approved artifact promoted and Production verification passed** |
| Owner approval / Actor | Developer; original scope approved 2026-09-05. Owner PASS and exact-artifact Promotion/closeout authorized **2026-09-07**; supersedes the earlier PASS-pending handoff |
| Intended Behavior / Blast radius | Production uses the tested security artifact while preserving business behavior and access; framework/build/runtime affects all portals |
| Root Cause | Older dependency resolutions and pinned overrides retained affected versions; historical install totals lacked advisory/exposure detail. Earlier two harness compatibility corrections preserved strict business assertions |
| Branch / Upstream | `spike/next-major-security-upgrade` / `origin/spike/next-major-security-upgrade` |
| Local HEAD / Remote HEAD / Ahead-Behind | Documentation closeout commit containing this matrix / same branch publication ref after verified normal push / **0/0**. Parent is `4a325b7a82be92e47799df64e9ee808122a8a28b`; exact documentation commit is in the final report and local `promotion-final-publication.json`, rather than recursively embedded in its own contents |
| Worktree / Staged | **Clean / empty after closeout publication**, verified in `promotion-final-publication.json`; source was unchanged and clean at fresh Promotion Gate 0 |
| Current Source / Pushed Source | **cc0af9998e3b5040d9cfa77753239b90aa01ce4b**, tree **a6da6073ea8d0f4d6475712d7c5f32b36e55e6a1**; committed/pushed tested source. Later documentation commits change no application/test/dependency/config bytes |
| Source Complete | **Yes**; this Promotion round has **0** functional/test/dependency/config changes |
| Tests Passed | **Yes — retained required regression evidence** tied to the identical source/config/lock; no fixture suite rerun this round. Fresh Production smoke and artifact verification passed |
| Retained regression coverage | Booking **23/23**, History/Payment **10/10**, Admin Assignment **18/18**, retrospective DB/runtime **38/38**, built authenticated User/Coach/Head Coach/Admin/Super Admin role/session checks **45**; all final required cases executed/passed, no final fail/skip |
| Retained build / deterministic evidence | Windows/Linux clean installs and graphs; full/omit-dev audits zero; TSC, lint zero warnings, mojibake 265, webpack build 94/94; architecture/manifest 34; Wallet 45; Assignment state 39; pricing 14; Progressive pricing 17/entry 31/transactions 33/coupon 38/batches 44/integration 29/notifications 16/Legacy 32. Earlier failures and bounded corrections remain dated history |
| Audit baseline / Final audits | Historical aggregate-only **10 vulnerabilities** is preserved. Fresh remediation baseline: **26 unique GHSA** (17 high/7 moderate/2 low), **15 affected npm labels** (10 own-advisory packages + 5 inherited); omit-dev 8 labels. Final successful Windows/Linux full and omit-dev audits: **0 npm-graph findings**, retained from 2026-09-05; not whole-system clearance |
| Final dependency lock | SHA256 **AD252F85DFAAF55DC58638B71860DB672488B5669BC254B9C82909FFE8838DDA**; actual deployed lock downloaded/read-only and matched again on 2026-09-07 |
| Final versions | Next/eslint-config-next 16.2.12; sharp 0.35.4/libvips 8.18.6; ws 8.21.0; PostCSS 8.5.28; nanoid 3.3.18; brace-expansion 1.1.18/5.0.9 (dormant @2 override 2.1.4); js-yaml 4.3.2; Babel core 7.29.7; browserslist 4.28.9; selector-parser 6.1.4 |
| Linux / optional native evidence | Retained direct proof: disposable Linux x64 glibc, Node 24.16.0/npm 11.13.0, sharp-linux-x64 0.35.4, sharp-libvips-linux-x64 1.3.3, SWC 16.2.12, PNG/JPEG/WebP passed. Cloud native selection remains an inference from identical lock/npm ci/Node/platform plus hosted image smoke, not direct cloud binary introspection |
| Committed | **Yes** — security source and documentation-only closeout on the same branch |
| Pushed | **Yes** — normal non-force publication; final remote/clean/ahead-behind verification recorded separately |
| Deployed / Artifact ID | **Yes — existing Production artifact dpl_G9Lg59UdXZ8LSVkBYjYfwVmMJxPq**, READY/PROMOTED; no new deployment or rebuild requested |
| Artifact URL | https://new-athlete-badminton-school-89vusndmx-aachanin1s-projects.vercel.app |
| Deployed Source / Artifact Tree | **cc0af9998e3b5040d9cfa77753239b90aa01ce4b** / **a6da6073ea8d0f4d6475712d7c5f32b36e55e6a1**; identical to Owner PASS |
| Promoted | **Yes**, command succeeded 2026-09-07 **02:17:56 UTC / 09:17:56 Asia/Bangkok**; exact artifact promoted once, without rebuild/replacement/manual alias changes |
| Artifact continuity | Fresh before/after verification: same ID/SHA/tree/lock, 401/401 uploaded source SHA1 hashes and 256/256 retained source/config/test fingerprints match; createdAt/buildingAt/ready timestamps unchanged |
| Production Active / URL | **Yes — security artifact active** at https://www.newathleteschool.com ; existing Makeup behavior remains included |
| Production aliases | All four map to the passed artifact: `www.newathleteschool.com`, `new-athlete-badminton-school.vercel.app`, `new-athlete-badminton-school-aachanin1s-projects.vercel.app`, `new-athlete-badminton-school-aachanin1-aachanin1s-projects.vercel.app` |
| Production health / Browser | Fresh 2026-09-07 checks: root/health/login 200 on all four aliases and immutable URL; public/protected redirects and API 401/405 boundaries passed; local + two allowed remote image optimizations 200, unlisted host 400; 30 static assets, no page/console/hydration/static errors; public/login screenshots inspected |
| Production logs | Exact deployment, **2026-09-07 02:17:57–02:19:30 UTC** (09:17:57–09:19:30 Bangkok): no error/fatal entries and no 5xx. Observed 401/405 match intentional anonymous boundary checks. Bounded observation only; no claim about all future traffic |
| Owner UAT Passed | **Yes — 2026-09-07**, exact artifact/SHA/tree/lock above; this security PASS is separate from historical Makeup PASS |
| Manual Production UAT / Production UAT Passed | **Not rerun / not claimed as a second manual PASS**; automated post-Promotion checks passed, with no observed difference requiring another Owner round |
| Controlled Write UAT | **None on staged/Production**. Earlier disposable local fixture lifecycle and write-flow tests remain retained evidence; no fixture mutations this round |
| Feature Enabled | **No feature-control changes**; dependency patch activated by exact Promotion |
| Allowlisted | **No allowlist changes** |
| Migration Source / Migration Applied | **No source migration change / no remote migration**; earlier existing migrations applied only in authorized disposable local resets |
| Environment / Secrets / Settings | **No persistent changes**. Existing Vercel protection credential reused read-only in memory on exact permitted hosts; no new token/share URL/protection setting |
| Production Data Changed | **No task-attributable business writes**; verification used anonymous GET/browser display only |
| Data Repaired | **No** |
| Customer Impact | Production now serves the security dependency patch; no task-attributable regression observed in bounded checks; business behavior and role protections unchanged |
| Financial Impact | No financial mutation or pricing/payment/entitlement formula change. Earlier Owner transactions and their unaudited financial effects remain outside scope |
| Rollback candidate | **dpl_431Mp3VuDJfN9qyBA4MyK4tc2nAf**, https://new-athlete-badminton-school-4r8x21gj8-aachanin1s-projects.vercel.app ; source `8148249f4dc5a626fefdd70834e93ffebd55d1a1`, tree `656a7b7c25c6f0323932598976232a2ed861cbfe`; READY, root/health/login 200 verified before Promotion. Rollback may reintroduce old dependency risks; no rollback performed/authorized by inference |
| Bundled-copy residual risks | Next compiled Babel 7.26.10, browserslist 4.28.1, nanoid 3.1.32 and ws 8.2.3 are not patched by root overrides. Retained source/trace analysis: trusted SWC build, no user target/stats input, secure default nanoid use and Node 24 native WebSocket make identified Production trigger conditions absent. Dev HMR ws residual remains; loopback listener mitigation. Reassess if these conditions change; audit zero is not global safety |
| Git integration / Publication safety | Production branch **main**, this spike branch remains non-production. Git Preview artifacts from documentation pushes do not replace the Owner-passed Production artifact. Raw evidence/env/auth state/reports remain excluded from Git and deployment upload |
| Changed files / Counts | This round: exactly **3 documentation files** — `PROJECT_STATE.md`, `TODO-CODEX.md`, `DEVELOPMENT_TODO.md`; functional/test/dependency/config **0**, bounded additions **0**. Earlier implementation total 7 paths is retained history |
| Scope Expansion / Scope Breach | **None / None**; no new business flow, protected-domain edit, rebuild, remote data operation or extra tracked path |
| Documentation Drift | **Resolved** — earlier PASS-pending/Production-not-active claims are superseded by this matrix and explicitly dated history; TODO derives from this matrix |
| Blocker | **None** |
| Remaining Work / Next Gate / Next Action | **No remaining work for this task. Wait for Owner to select the next task**; do not start Parking Lot implementation |
| Parking Lot authorization state | All **8** candidates preserved in the existing order and remain unselected for implementation, including **LV 0 · นักเรียนใหม่/รอประเมิน**; completed Makeup history retained |
| Task Done | **Yes** — exact Promotion, required Production verification and documentation publication complete |

Detailed advisory exposure/range/path evidence and the complete before → after
index remain in the dated 2026-09-05/06 dependency-security records in
DEVELOPMENT_TODO.md. The 2026-09-07 record adds exact Promotion and closeout.

Local-only, Git/deployment-excluded evidence: `.playwright/security-dependencies/`
contains `promotion-before-continuity.json`, `promotion-command-result.json`,
`promotion-after-continuity.json`, `production-smoke.json`, public/login images,
`promotion-runtime-logs-0.md` through `-2.md`, and final publication/compliance
records. Earlier test/build/native/audit evidence is retained, not relabeled as
fresh executions. No Production login submission or business mutation was used.

## Historical / Superseded — 2026-09-05 LV 0 Parking Lot documentation registration

State observed by the separate registration task at commit 049d398. Its global
Active Task/unknown security-edit facts are superseded by the current matrix
above; the eight Parking Lot decisions and implementation boundaries are retained.
...
artifact remains ineligible for Promotion. The exact replacement is READY with
aliases 0 and read-only smoke/log checks completed. Owner UAT remains.
...
| Task Status | **READY FOR OWNER UAT**; not TASK DONE |
...
| Local HEAD | Application/config `8148249f4dc5a626fefdd70834e93ffebd55d1a1`; documentation HEAD is the documentation-only commit containing this closeout (resolve with `git log -1 --format=%H -- PROJECT_STATE.md`) |
| Remote HEAD | Application `8148249f4dc5a626fefdd70834e93ffebd55d1a1` verified by `git ls-remote`; documentation-only HEAD is published separately on the same upstream |
| Ahead / Behind | Application publication `0/0`, clean. Documentation-only closeout publication must also finish `0/0` and clean, without rebuilding |
| Source Complete | **Yes** — UI/identity, exclusions and test correction; recovery and exact staged verification completed |
| Current Source / Pushed Source | Application/config `8148249f4dc5a626fefdd70834e93ffebd55d1a1`, committed/pushed. Backend Bangkok weekday fix retained unchanged; documentation-only HEAD is separate |
| Application SHA / Tree | `8148249f4dc5a626fefdd70834e93ffebd55d1a1` / `656a7b7c25c6f0323932598976232a2ed861cbfe`. Github/application metadata match; all 401 uploaded file SHA-1 hashes match clean local inputs, mismatches `0` |
...
| Tests Passed | **Yes, required checks**. Retained same-source/dependency results, not fresh reruns: UI `9/9`, Booking `23/23`, retrospective runtime `38/38`, affected Assignment `3/3`, full Assignment E2E `18/18`, Wallet `45/45`, Assignment state `39/39`, TypeScript `--noEmit --incremental false`, zero-warning lint, mojibake `265`, local build `94/94` static pages. Fresh recovery, architecture/manifest `34/34`, diff/secret compliance and staged remote build/smoke passed. E2E last-run files remain passed, local residue `0` |
...
| Outstanding Verification | Owner no-write UAT of exact replacement. Staged real POST not run/authorized; no technical gate waived. Local UI interception does not reconcile Production transactions |
...
| Committed | **Yes** — Application/config/test `8148249f4dc5a626fefdd70834e93ffebd55d1a1`; documentation-only closeout separate |
| Pushed | **Yes** — non-force same branch; remote Application SHA verified; no merge/rebase/branch change |
...
| Protected Invariance | API/backend/canonical helper diff paths `0`; server page only two identity-prop additions; retrospective handlers unchanged; User Schedule, AGENTS/shared UI/package/lockfile/other configs/migrations unchanged. Six staged functional/test/config blobs match tested content |
...
| Deployment Exclusion Verification | CLI `59.11.2` dry-run before exclusions `472` entries / `13858341` bytes with forbidden categories. After recovery/immediately before upload `405` entries, forbidden `0`, required `355/355`; committed upload bytes `8115768`. Uploaded source: `401` files / `550` tree entries including virtual directories; forbidden `0`, raw SHA-1 mismatches `0`. No secret/auth-state values printed or evidence removed. Safe manifest does not prove historical deployments were secret-free |
...
| Replacement Deployment ID / URL / State / Aliases | `dpl_431Mp3VuDJfN9qyBA4MyK4tc2nAf` / https://new-athlete-badminton-school-4r8x21gj8-aachanin1s-projects.vercel.app / **READY**, target **production** / aliases **0** via deployment aliases endpoint |
| Deployed | **Yes — staged Production-target only**, one `--prod --skip-domain` invocation; no Promotion/domain assignment |
| Deployed Source / Rollback Candidate | Production/rollback remains READY `dpl_EzbDkjbuMA3q2qcbX6G3aHg1tACW`, Application `66be707dcbcffc810cf484fc059448373ceda72f`, https://new-athlete-badminton-school-p8rzadd2k-aachanin1s-projects.vercel.app. Health/login 200/200; all four established aliases unchanged after push/deployment |
| Production Active | Corrective **No**; existing Production unchanged |
| Staged Smoke / Logs | Read-only root/health 200; `/login` 307 to `/auth/login`, `/auth/login` 200; `/admin/makeup` 307 to login; actual `/_next/static/chunks/webpack-a1425f7572da71b3.js` 200. Bounded `--since 30m --limit 100`: 6 GET, error/5xx 0, non-GET 0, Makeup POST 0; separate error-level scan empty |
...
| Feature Enabled | Existing controls unchanged; corrective available on staged URL only, not Production-active; live settings not re-audited |
| Allowlisted | **No Developer change** |
| Production UAT / Owner UAT Passed | Replacement **Not yet — awaiting Owner PASS/FAIL**; prior staged UX FAIL preserved; no new Production UAT |
...
| Documentation Drift | Resolved: cleanup/recovery/publication/staged facts supersede obsolete blockers; history retained. PROJECT_STATE → TODO-CODEX → dated history reconciled. Application/config SHA distinct from documentation-only HEAD |
| Blocker / Remaining Work | No technical blocker. Owner no-write UAT remains; real-write UAT requires separate exact learner/source/target authorization and reconciliation plan |
| Task Done | **No** |
| Next Gate / Next Action | Owner reviews exact replacement and same-source evidence, returns PASS/FAIL. Stop before Create; no Promote/alias change, Production write, rebuild after PASS, or new task |
| Parking Lot authorization state | Unchanged and unauthorized; same Active Task |

### Owner no-write handoff and limitations

1. Open the exact replacement URL above as Admin/Super Admin with Makeup access.
2. Inspect learner/source-month groups, including same-name learners.
3. Select next month, day, branch and time; check the selected summary.
4. Stop before “สร้างวันชดเชย” on the Production-connected staged artifact.
5. Review same-source local button evidence and return PASS/FAIL for this artifact.

Expected: correct Bangkok calendar/active slots, separate exact learners, no UI/runtime
error. Staged real POST is **not tested**; local UTC API/DB evidence and simulated UI
responses are separate. Controlled Write UAT needs exact learner/source/target and
reconciliation authorization. UI locking does not guarantee cross-tab/server idempotency.

Retained local evidence: `.playwright/makeup-create-evidence/` (12 images).
Desktop/mobile `*-pending-observed.png` and `*-confirmed-before-refresh.png`,
`before-fix-desktop.png` and `*-error-preserved.png` match the tested blobs now
committed in the Application SHA above. Success phases have POST=1 through rapid
clicks/keyboard/stale refresh. 400/409 reach POST=2 only on explicit user retry;
500/network/malformed stay POST=1, automatic retries=0. Local fixture residue=0.

Remote install reported 10 audit vulnerabilities (2 low, 8 high), permissive Node
engine and two install-script warnings. Dependency/lockfile/settings unchanged;
these warnings were not triaged/repaired in this UI-only scope. Remote build passed.
Safe upload evidence does not establish zero historical secret exposure or zero
financial effect of the earlier Owner transaction.
...
proved the database transition but failed completion-feedback UX. The next staged
artifact was rejected because it omitted an executable
`resolve_unassigned_round` client path. Both artifacts remain permanently
ineligible for Promotion. Owner UAT and read-only reconciliation passed on the
replacement corrective artifact, and that exact artifact is now Production-active
on all four established aliases without rebuild.

### Current Project Matrix

| Field | Current value |
| --- | --- |
| Active Task | **None — Awaiting Owner Selection**. Completed task: **PERMANENT ADMIN RETROSPECTIVE COACH ASSIGNMENT INTEGRITY** — corrective **ADMIN MAKEUP COMPLETION FEEDBACK** |
| Task Status | **TASK DONE — Owner UAT PASS; exact artifact Promoted without rebuild; Production verification passed** |
...
| Intended Behavior | All five Admin retrospective mutations have executable `runRetrospectiveMutation` calls and share one ref-guarded mutation/reconciliation lifecycle. Assign-only remains distinct; resolving an unassigned historical round requires a coach plus exact Attendance for every learner. A successful changed or idempotent response updates visible coach/group/Attendance state deterministically while `router.refresh()` reconciles without restoring stale actions |
| Confirmed UI Root Cause | Original UX cause: React state alone did not synchronously guard a second handler entry; success had no durable feedback; and `router.refresh()` was the sole completion signal. Confirmed scope omission in the first correction: the taught unassigned-round handler still invoked `assign_coach_to_round`, so `resolve_unassigned_round` existed only as a type/string; an `includes()` architecture assertion falsely passed. The API already returned sufficient canonical evidence, so no route change was needed |
| Branch | `spike/next-major-security-upgrade` |
| Local HEAD / Remote HEAD | Promotion-closeout documentation commit containing this matrix / same after publication; exact Production Application Source `66be707dcbcffc810cf484fc059448373ceda72f` |
| Ahead / Behind | `0/0` after documentation publication; staged/unstaged paths `0` |
| Source Complete | **Yes** — replacement corrective Application/Test Source committed and pushed at `66be707dcbcffc810cf484fc059448373ceda72f`, tree `43b77eeaa874088f25952e0e06b06d150e587b70` |
| Current Source / Pushed Source | `66be707dcbcffc810cf484fc059448373ceda72f` / same exact corrective Application Source |
| Tests Passed | **Yes.** Retrospective integrity `38/38`; Admin assignment `39/39`; conflicts `22/22`; lifecycle `55/55`; resolution `33/33`; teaching hours `20/20`; payroll `14/14`; Wallet `45/45`; full Admin Schedule E2E `17/17`; focused executable resolve case `1/1`; TypeScript; zero-warning lint; mojibake `265`; Production build `94/94`; prod readiness; diff checks; desktop/mobile delayed-response visual verification; post-build local root/health/login/static/auth checks |
| Bounded Corrections | **2/2 at Product-artifact level** — first completion-feedback correction produced rejected `dpl_8C8...` because executable resolve was omitted; the second restored that distinct path and replaced the weak assertion/E2E. One test-only adjustment scoped a global action-count assertion to the exact target card; it did not change Product behavior. The corrected Product failure did not recur |
...
| Committed / Pushed | **Yes / Yes** — replacement corrective commit `66be707dcbcffc810cf484fc059448373ceda72f`; Promotion-closeout documentation committed/pushed after this matrix |
...
| Old Artifact UAT Reconciliation | Owner performed one authorized assignment on the old artifact. Group `dd41cae4-1b60-4b4f-a84f-a05fd954f29e` retained its identity/name and four membership identities; coach became `05ca3f2e-fe83-4a80-ba60-6cbcf52fdaa5`; exactly one legacy row, one activity row, and one coach notification exist; Attendance delta `0`; all four sessions remain `scheduled`; reservation `0` is expected for the historical slot; duplicate/orphan/empty anomalies and protected financial/Wallet deltas are `0` |
| Rejected Corrective Artifact | `dpl_8C8uRhMyNtNUEx5Pq6KQ5wDXLSiV`, Application `3954094c9c22faee90a74099bb64987005e432c3`: PM review **CORRECTION REQUIRED** because executable resolve was absent; aliases `0`; no Owner UAT requested/performed; permanently ineligible for Promotion |
| Current NULL-group Inventory | Fresh 2026-08-31 read-only evidence after Owner UAT: `26` NULL-coach groups, `17` populated, `27` memberships, all populated past (`0` current/future); `9` slots mix a populated NULL group with a populated coached group; preservation markers `0`. These are state shapes, not repaired or confirmed incidents |
| Exact Artifact / Source | `dpl_EzbDkjbuMA3q2qcbX6G3aHg1tACW`; `https://new-athlete-badminton-school-p8rzadd2k-aachanin1s-projects.vercel.app`; target/state `production/READY`; Source `66be707dcbcffc810cf484fc059448373ceda72f`; tree `43b77eeaa874088f25952e0e06b06d150e587b70`; region `icn1` |
| Replacement Owner UAT Reconciliation | **PASS.** One `PATCH /api/admin/makeup` returned `200`. Slot `8f7b98fd-40fd-47d2-9dbe-79af176c2986`; group `5c7ec612-f744-4ab0-aa9e-4ab885dfbb35`; coach `05ca3f2e-fe83-4a80-ba60-6cbcf52fdaa5`. The same three membership IDs remain mapped to the same three sessions with exact learner identity; one legacy assignment and one activity `admin_retrospective_assignment_resolve_unassigned_round` exist; Attendance is exactly three `present`; sessions are exactly three `completed`; intended notifications are exactly three; duplicate memberships, Wallet, Payment, and Coupon deltas are `0`; historical reservation count is correctly `0` |
| Deployed Source / Deployment ID | Production-active Source `66be707dcbcffc810cf484fc059448373ceda72f` / exact `dpl_EzbDkjbuMA3q2qcbX6G3aHg1tACW` |
| Production Smoke / Logs | All four alias mappings point to the exact artifact. Public root, health, Login, and promoted static asset returned `200`; anonymous Admin Makeup returned `307` to Login. Two team-scoped Vercel aliases remain protected by Vercel SSO and resolve to its Login boundary when fetched anonymously. Post-Promotion runtime error/fatal/5xx are `0/0/0`; no Admin Makeup mutation request occurred after Promotion |
| Production Artifact / Aliases | Exact `dpl_EzbDkjbuMA3q2qcbX6G3aHg1tACW`, Application `66be707dcbcffc810cf484fc059448373ceda72f`, is active on `www.newathleteschool.com`, `new-athlete-badminton-school-aachanin1-aachanin1s-projects.vercel.app`, `new-athlete-badminton-school-aachanin1s-projects.vercel.app`, and `new-athlete-badminton-school.vercel.app`. Prior Production `dpl_D2h2jtcVUJLLVGEz4uMNgQTys25a` remains `READY` as rollback evidence |
| Deployed / Promoted | **Yes / Yes.** One exact `vercel promote` invocation succeeded at `2026-08-31T13:02:57Z`; retry/redeploy/rebuild/new-deployment/manual-alias/rollback counts are `0/0/0/0/0/0`. Deployment ID, SHA, URL, and created/building/ready timestamps remained unchanged |
| Feature Enabled / Allowlisted | **No change / No change** |
| Production Active | Existing database transition and corrective application **Yes** |
| Owner UAT / Production UAT | Replacement corrective artifact **PASS / automated post-Promotion verification PASS**. Old artifact remains backend PASS but UX/overall FAIL; rejected corrective artifact was never offered for UAT |
| Controlled Write UAT | **Performed once by Owner on each exact UAT artifact; Developer performed none.** The old target and replacement target must not be reused, reversed, replayed, or repaired |
| Data Repaired / Production Data Changed | **No / Yes.** Owner UAT legitimately changed the two selected historical groups across the two UAT rounds; Promotion itself changed no business data and no separate repair occurred |
| Customer Impact / Financial Impact | Old UAT assigned one selected coach and sent one coach notification without Attendance/status change. Replacement UAT assigned the selected coach, recorded three `present` Attendance rows, completed the same three sessions, and sent exactly three learner schedule notifications. Wallet `0`, Payment `0`, Coupon `0`, and pre-existing Ledger/Progressive allocation counts `2/2` remained unchanged / **None** |
| Coach Check-in Limitation | Target coach check-in count is `0`; Admin retrospective Attendance is the authorized exception and did not create selfie/GPS/check-in evidence. Assignment and Attendance alone do not make the historical round coach-payable |
| Advisor Results | Local DB lint retains only the two pre-existing Lesson Wallet temporary-table analyzer findings; fresh linked security/performance counts are `30/333`, with no corrective schema delta |
| Documentation Drift | **Resolved at closeout** — prior pending-UAT and prior-Production claims are superseded while legitimate historical evidence remains |
| Blocker | **None** |
| Remaining Work | **None for this task** |
| Task Done | **Yes** |
| Next Gate / Next Action | **Await Owner selection of a new task. Do not repeat, reverse, replay, or repair either completed UAT target** |
| Parking Lot authorization state | Existing Parking Lot remains unchanged and unauthorized pending explicit Owner selection |
...
Production migration, Owner cross-day Wallet UAT, exact-artifact Promotion, and
Production verification are complete. Application Source
`34eb3fb3ba4e0178d2065862623829319858de2d` is committed, pushed, and active on all
four established Production aliases through exact artifact
`dpl_D2h2jtcVUJLLVGEz4uMNgQTys25a`. No rebuild or replacement deployment occurred.

### Historical Matrix — Permanent Schedule Slot Template Integrity + Urgent Aug 30–31 Wallet Recovery
...
| --- | --- |
| Active Task | **None — Awaiting Owner Selection** |
| Task Status | **TASK DONE — Owner UAT PASS; exact artifact Promoted; Production verification passed** |
...
| Branch | `spike/next-major-security-upgrade` |
| Local HEAD / Remote HEAD | Containing Parking Lot registration documentation commit / same after publication; pre-registration Gate 0 was exact `a7183e05f04811cff2f415a39cc9384754ea9596` / same; exact Application Source remains `34eb3fb3ba4e0178d2065862623829319858de2d` |
| Ahead / Behind | `0/0` after Parking Lot registration publication; staged paths `0` |
| Source Complete | Completed Product task: **Yes** — exact permanent Application/Test/Migration Source is committed and pushed at `34eb3fb3ba4e0178d2065862623829319858de2d`. This registration: **documentation complete only; future Product Source not started and not authorized** |
...
| Parking Lot Registration Result | **TASK DONE after documentation commit/push verification** — registration only; future Product task remains not started and not authorized |
| Registration Verification | Documentation-only checks: complete unstaged/staged diff review, exact-path/count/order/authorization checks, `git diff --check`, and mojibake. TypeScript, lint, build, E2E, DB reset, Product tests, Deploy, and Product/Production UAT were not run for this registration |
...
| Functional / Test / Documentation / Migration Files | Delivered permanent set `4 / 5 / 4 / 1`; post-UAT/Promotion closeout delta `0 / 0 / 3 / 0`; this Parking Lot registration delta `0 / 0 / 3 / 0`. Migration path `supabase/migrations/20260828020022_permanent_schedule_slot_template_integrity.sql` was created by Supabase CLI and contains no Production UUIDs |
...
| Committed / Pushed | **Application/Test/Migration: Yes / Yes. TASK DONE documentation: Yes / Yes. Parking Lot registration documentation: Yes / Yes after publication** |
...
| Deployed Source | Production artifact `dpl_D2h2jtcVUJLLVGEz4uMNgQTys25a` contains exact Application `34eb3fb3ba4e0178d2065862623829319858de2d`; deployment/build identity and timestamps remained unchanged through Promotion |
| Deployment ID / URL | `dpl_D2h2jtcVUJLLVGEz4uMNgQTys25a`; `https://new-athlete-badminton-school-mev44zqza-aachanin1s-projects.vercel.app`; target/state/substate `production/READY/PROMOTED`; region `icn1`; build `bld_10ack8e9s`; alias assigned `2026-08-28T04:20:18.590Z` |
| Owner UAT Evidence | **PASS on the exact staged artifact.** Owner redeemed Aug 30 15:00–17:00 to the existing Aug 31 16:30–18:00 slot and Aug 31 16:30–18:00 to the existing Aug 30 15:00–17:00 slot. Both succeeded with no charge; Developer performed no redemption |
| Staged Smoke / Logs | Before Promotion, exact staged root/health/login/static `200/200/200/200`; anonymous Wallet `307`; both Owner Wallet POSTs returned `200`; error/fatal/5xx `0/0/0` |
| Production Artifact / Aliases | All four established Production aliases resolve to exact `dpl_D2h2jtcVUJLLVGEz4uMNgQTys25a`; aliases added/removed/unexpected `0/0/0`. Prior `dpl_4aig1hqYJH44vzcQXFojsSpxCxDr` remains `READY` as rollback candidate |
| Deployed / Promoted | Completed Product task: **Yes / Yes — one exact Promote invocation; retries/rebuilds/new deployments/manual alias commands `0/0/0/0`**. This registration: **No action / No** |
...
| Production Active | Completed Product task: **Yes** — urgent two-row repair, permanent DB protection, and exact Application `34eb3fb...` are active. This registration changes Production-active behavior by **No** |
| Owner UAT / Production UAT | Completed Product task: **PASS on exact staged Production artifact / no second manual run required; automated post-Promotion Production verification passed**. This registration: **Not run / Not run** |
| Controlled Write UAT | Completed Product task: Owner performed the two exact Wallet redemptions once each; Developer performed none. Exact transactional metadata repair earlier completed with affected row count `2`. This registration: **Not run** |
| Data Repaired / Production Data Changed | Completed Product task: **Yes / Yes.** Developer repair changed exactly two `schedule_slots.template_id` values: `bfacfafd-cadc-4534-9c8a-bf9b5434c267` -> `eabcf632-2e05-41ad-a9d5-d1eae79f439a`; `4896fce1-9508-4b69-9024-905a01a71bb0` -> `d6a54b6f-9bb1-43dd-be84-66db37dfb494`. Later Owner UAT legitimately redeemed the two credits and created the exact two target sessions; no Developer customer redemption occurred. This registration: **No / No** |
| Repair Evidence / Protected Delta | Transaction locked the exact two slots and credits, repeated all predicates, and required affected rows `=2`. Slot combined pre-write fingerprint was `983da36a750e6980de0476c43addc494`; post-write row fingerprints are `262e16b50a9385efadf239fca74ea4e5` and `06d1863771d6afd766d2b94413cb9a46` (post combined `6c1b8e4c22d84329f1c3c2e997fa58b1`). Template `eba7f353bd29ac19528c68e2823eb308`, credits `2a97bb3d3c85e781ea48a8c6babc9eca`, members `d41d8cd98f00b204e9800998ecf8427e`, sessions `767097160d5318811112275454cb9520`, booking `ea4d53e82b7855b02af1b419d193e4a9`, payments `d41d8cd98f00b204e9800998ecf8427e`, allocation `e16f2c8aa4920b5d88777b2a43b8277e`, coupons `d41d8cd98f00b204e9800998ecf8427e`, and related attendance `d41d8cd98f00b204e9800998ecf8427e` were invariant inside the transaction. Global attendance advanced externally `3648` -> `3651` before the repair transaction and stayed `3651` pre/post inside it; it is not attributable to this write |
| Credits After Owner UAT | Both are `redeemed` exactly once: `de0d599b...` at `2026-08-28T04:09:42.917813Z` -> session `abde753a...` on original slot A, and `80117017...` at `2026-08-28T04:10:11.783474Z` -> session `a6ba563d...` on original slot B. Descendant count is exactly `2`; both target sessions are `scheduled` and preserve child identity |
| Remaining Legacy NULL Inventory | Historical Production read-only classification observed at the prior task closeout: exact `78` total (`1` then-current/future), no-match `48` total (`2` then-current/future), ambiguous `0`; this is not fresh/current inventory, and no query or additional row change was authorized for this registration |
| Post-UAT Protected Delta | Booking remains `verified` with unchanged `updated_at=2026-08-15T10:15:46.163364Z`. UAT and post-Promotion Payment/Coupon/Progressive-allocation/Ledger/Finance/target-Attendance writes are `0/0/0/0/0/0`; one allocation and one ledger row remain the pre-existing Aug 15 payment evidence. A post-Promotion external Head Coach Save added one assignment membership for redeemed session `abde753a...`; activity/log attribution proves normal assignment workflow, not Wallet/Promotion side effect, and target session state/timestamp remained unchanged |
| Advisor Results | Security `30 -> 30`, performance `333 -> 333`; added/removed findings `0/0` for both and no new security regression. Existing findings remain out of scope; see [Database Linter](https://supabase.com/docs/guides/database/database-linter) and [Going into Production](https://supabase.com/docs/guides/deployment/going-into-prod) |
| Rollback Readiness | **Blind two-row NULL rollback is now prohibited** because Owner redemption changed credit/session state. Any data rollback requires a new Hard Stop and evidence-driven plan. Prior Application artifact `dpl_4aig1...` remains `READY` as code rollback candidate |
| Customer Impact / Financial Impact | Completed Product task: **Positive:** both exact Wallet credits redeemed successfully to the two original teaching slots with correct child identity / **None** — no Payment, Coupon, new Allocation, Ledger, Finance, refund, price, or Attendance write. This documentation-only Parking Lot registration: **None / None** |
| Known Limitations | Existing legacy NULL inventory remains intentionally untouched. Remote build reports the existing `8` dependency vulnerabilities; dependency changes are out of scope |
| Production Smoke / Logs | Canonical root/health/login/static `200`; anonymous Wallet `307`. Two protected team aliases map exactly but return expected Vercel SSO `302` when opened directly. Post-Promotion warning/error/fatal/5xx `0/0/0/0`; latest `200`-request sample is all `info`. The only mutation log is the attributed external Head Coach assignment Save `POST 200` |
| Documentation Drift | **No after Parking Lot registration publication**; `PROJECT_STATE.md` is authoritative and `TODO-CODEX.md` derives its short status here |
| Blocker | **None** |
| Remaining Work | **None for this task** |
| Task Done | **Yes** |
| Next Gate / Next Action | **Owner later selects a Parking Lot candidate and approves a separate implementation Scope Contract; do not start Product/Production audit or queued work automatically** |
| Parking Lot authorization state | Exactly seven candidates are registered, all unselected and unauthorized, in Owner order: `1.` **END-TO-END SCHEDULE LIFECYCLE & LEGACY SLOT PROVENANCE HARDENING**; `2.` **HEAD COACH VERIFIED-BOOKING ASSIGNMENT ALERT**; `3.` **LINE EXTERNAL-BROWSER HANDOFF AUDIT**; `4.` **THAI UI TERMINOLOGY & SHARED HELPER**; `5.` **EXTERNAL HEAD COACH ASSIGNMENT SAVE HTTP 500 ATTEMPTS**; `6.` **HOMEPAGE LV COPY AUDIT/FIX**; `7.` **ADMIN RECOMMENDATIONS — ROUND RISK ALERTS, CHRONOLOGICAL ORDER & READ-ONLY DETAIL MODAL**. Item `1` is registered only and has status **PARKING LOT — OWNER SELECTION REQUIRED; NOT AUTHORIZED TO START**; no Active Task is selected and no candidate may start automatically |
...
| Bounded Correction Attempts | **1/2 used.** The only correction changed the new UAT expiry assertion from textual timestamp formatting to exact-instant comparison after the database proved the same millisecond. Product Source and migration did not change; attempt 2 was unused |
...
## Current Parking Lot Priority 1 — End-to-End Schedule Lifecycle & Legacy Slot Provenance Hardening
...
- Owner registered this candidate at Parking Lot position `1` on 2026-08-28 but
  did not select it as the Active Task. This registration authorizes documentation
  publication only; it does not authorize Product/Production audit,
  implementation, tests or fixture mutation, Migration, Deploy, Environment,
  feature/allowlist/permission change, Production query, or data operation.
- Future intended behavior: template identity is immutable after creation;
  schedule changes deactivate the old template and create a new one; existing
  learners, Coach/group, check-in, Attendance, Teaching Program, Payroll,
  history, and financial evidence remain on the original physical slot; only new
  Booking, Reschedule, Makeup, and Wallet targets see the new active template.
- A separately authorized future task must audit every normal `schedule_slot`
  creation path and require one exact active canonical template for branch,
  course, Bangkok weekday, start time, and end time. Missing, duplicate,
  ambiguous, mismatched, or raced provenance must fail closed with zero residue.
  Referenced template and physical-slot identity must not change retroactively,
  and booking-session date/time/branch/course/learner identity must remain
  consistent with its exact `schedule_slot_id`.
- Future active-flow regression for Kids uses **Progressive Kids Group only**.
  Historical Kids rows are compatibility/regression protection only: do not
  create a new Legacy Kids booking, reopen Legacy entry, or reprice, rewrite, or
  backfill historical Kids rows. Adult Group, Private, Family Private, Wallet
  safety/expiry, and Family atomicity remain protected.
- Legacy NULL slots require fresh evidence in that future task: exact unique match
  may bind on use or be proposed as an exact-row repair; no-match requires an
  Owner decision; ambiguous must fail closed. Bulk backfill is prohibited, and
  any Production repair requires a separate exact-row Owner-approved Production
  Data Operation.
- Detailed intended behavior, protected domains, future audit/verification
  matrix, Unknowns, and the 17:00–19:00 to 17:30–19:00 Owner example are preserved
  in the dated 2026-08-28 registration record in `DEVELOPMENT_TODO.md`.

## Current Parking Lot Priority 2 — Head Coach Verified-Booking Assignment Alert

Status: **PARKING LOT — OWNER SELECTION REQUIRED; NOT AUTHORIZED TO START**.

- Owner decision on 2026-08-26 originally listed **HEAD COACH VERIFIED-BOOKING
  ASSIGNMENT ALERT** first; the 2026-08-28 Owner registration moves it to position
  `2` while preserving its relative order among the six earlier candidates. This
  registration does not select it as the Active Task;
  the Active Task is **None — Awaiting Owner Selection**, and this Parking Lot item
...
## Current Parking Lot #7 — Admin Recommendations Round Risk Alerts
...
- The 2026-08-27 Owner revision supersedes the current rules from the original
  ...
  Task remains **None — Awaiting Owner Selection**; item `7` remains unselected,
...
- Next Action: **Owner separately selects item `7` and approves a future
...
| Field | Current value |
| --- | --- |
| Active Task | **ADULT GROUP + FAMILY PRIVATE 10-MONTH ENTITLEMENT / CROSS-MONTH LESSON WALLET** |
| Task Status | **READY FOR OWNER UAT — exact staged artifact ready; Owner PASS/FAIL awaiting; not Promoted** |
| Owner Policy | **Confirmed 2026-08-23:** ten months applies only to Adult Group and Family Private package tiers above one unit; entitlement starts at the one exact approved Payment `verified_at` and ends at the close of inclusive Bangkok calendar month 10; missing/ambiguous Payment or historical tier evidence fails closed; Family Private exact hour is one atomic all-participant unit; existing credits are not backfilled/recalculated/revived and re-wallet preserves original evidence/expiry |
| Intended Behavior | Eligible Adult/Family package credits can be redeemed across months through the exact expiry without another payment; Adult single, Private single, and all Kids remain same-month. Family Private store/redeem moves all self/child participants atomically as one hour/card while preserving identity. Wallet page reads are side-effect-free; over-capacity remains non-blocking; destination assignment remains for Head Coach Save |
| Root Cause | **Proven from Source/schema/local behavior; matched the approved hypothesis.** The former API derived expiry from the original session month, enforced same-month for every credit, created one credit per `booking_session`, and used multiple compensating statements. Private booking rows represent participants while `bookings.total_sessions` represents time units, so one Family hour could split into multiple credits. Payment rows are not uniquely constrained and historical tier validity must be resolved explicitly, requiring fail-closed evidence and atomic database RPCs |
| Branch | `spike/next-major-security-upgrade` |
| Local / Remote HEAD | Documentation-only READY handoff descendant of Application SHA `ebf368dcfcaecd68e42dd61de45d35d743232b99`; exact documentation SHA is reported in the final handoff because a commit cannot embed itself |
| Ahead / Behind | `0/0` after documentation closeout push; staged paths `0` |
| Source Complete | **Yes** — all intended behavior is committed and pushed within the exact allowlist |
| Tests Passed | **Yes.** Lesson Wallet deterministic `29/29`; atomic local RPC UAT passed every approved scenario with residue `0`; Coach Assignment Lifecycle `52/52`; Coach Teaching Hours `20/20`; Booking Playwright `12/12` with residue `0`; TypeScript, ESLint with warnings `0`, mojibake (`264` files), Production build (`94/94`), and diff checks passed |
| Committed / Pushed | **Application/Test/Migration: Yes / Yes. Documentation READY handoff: Yes / Yes after this publication** |
| Current Source / Pushed Source | `ebf368dcfcaecd68e42dd61de45d35d743232b99` / same exact Application SHA |
| Deployed Source | Staged Production-target Source `ebf368dcfcaecd68e42dd61de45d35d743232b99`; canonical Production Source remains `a370673d06e61e409ec9b1de648ae4fbb1070c2d` until Owner PASS and exact Promotion |
| Functional / Test / Documentation / Migration Files | `8 / 3 / 4 / 1`; total authorized paths `16`; added helper and migration were exact planned paths; dependency/lockfile/config changes absent |
| Scope Expansion / Scope Breach | **None / None.** Protected dirty file stayed excluded; no added path, pricing formula/tier change, customer write, or adjacent Private Identity work |
| Migration Source / Applied | `supabase/migrations/20260823090000_adult_private_ten_month_lesson_wallet.sql` at Application SHA `ebf368d...` / **Yes — linked project `tvnhholicwjtxdhlxfqs`, exactly once** |
| Migration Verification | History count `1`; new credit columns `8`; companion constraints `10`; Family unique index `1`; RLS enabled; RPC count/security-definer/pinned-search-path `2/2/2`; service-role execute grants `2`; anon/auth table or RPC grants `0`; companion rows `0`; existing credits populated with new evidence `0` |
| Migration Metadata / Customer Rows | **Changed: one migration-history row plus additive schema/RPC metadata / Changed: 0**. Exact migration contains no apply-time business-row DML, seed, role, or vault update |
| Environment Changed | **No application/remote Environment, secret, feature-control, dependency, or package change.** Local Docker Supabase reset/UAT and clean dev restart only; Vercel Production-target build used existing Production environment without changing it |
| Feature Enabled / Allowlisted | **No feature-control change / No allowlist change** |
| Release Gates | Clean local migration reset; schema/security evidence; UAT residue `0`; deterministic `29/29`, `52/52`, `20/20`; Playwright `12/12`; TypeScript, lint, mojibake, build `94/94`, post-build root plus 3 static assets `200`, and diff compliance all passed |
| Deployed / Promoted | **Yes — staged Production-target artifact only / No**. Exactly one `deploy --prod --skip-domain` invocation; force/redeploy/Promotion/alias command counts `0/0/0/0` |
| Deployment ID / Exact SHA | `dpl_HzK2TM1j6pSd2VaUkMzCD9s8uPNL` / `ebf368dcfcaecd68e42dd61de45d35d743232b99`; immutable URL `https://new-athlete-badminton-school-lps2sz825-aachanin1s-projects.vercel.app`; target/state `production/READY`; aliases `0`; region `icn1` |
| Staged Smoke / Logs | PASS — root `200`, health `200`, login `200`, protected Wallet page `307` to Login, anonymous Wallet API GET `405`; bounded exact-deployment runtime warning/error/fatal/5xx `0/0/0/0`; no POST, form submit, Controlled Write UAT, or customer-data write |
| Alias Before / After | All four established Production aliases remained on `dpl_GjmdPaHq9iFhkXTPViF3KkrCjbG6` before and after; staged artifact aliases `0`; Production traffic moved **No** |
| Owner UAT | **Awaiting Owner** for exact staged artifact/SHA |
| Production Active / Production UAT | **No for this Application Source / Not run**. Existing Production remains on the prior Source; post-Promotion Production checks are not run before Promotion |
| Controlled Write UAT | **Not run** |
| Data Repaired / Production Data Changed | **No / No customer/business-row change**; migration metadata/schema changed as separately recorded |
| Customer Impact / Financial Impact | **None before Promotion / None**. Existing credits/payments/pricing/coupons/Ledger/Finance are unchanged |
| Protected Dirty File | Excluded, unstaged, worktree diff empty, and invariant before/after at Git blob `4521281d099efb189429a744909552d67871ff23`, SHA-256 `A934C28DD7EED94CF7E98A6959D3E74FC3A3FE348A74DC06C205EACC38CDD181` |
| Bounded Correction Attempts | **2/2 reasonable bounded correction rounds used; final gates all passed.** Product Root Cause and Intended Behavior never changed |
| Known Limitations | Remote advisor reports intentional INFO `RLS enabled with no policy` for the service-role-only companion table; new RPCs have no anon/auth grant. Baseline security warnings and existing build audit `8` vulnerabilities (`1` low, `7` high) remain outside scope. No Production Controlled Write UAT is authorized |
| Documentation Drift | **No after this READY handoff and Documentation Consistency Matrix** |
| Blocker | **None technical; Owner PASS is the required release gate** |
| Remaining Work | Owner performs 3–5 no-write UAT checks and returns PASS or FAIL. On PASS, Promote only this exact artifact/SHA without rebuild, then run automated Production health/log checks and final closeout |
| Task Done | **No** |
| Next Gate / Next Action | **Owner UAT on `dpl_HzK2TM1j6pSd2VaUkMzCD9s8uPNL` / `ebf368d...`; do not Promote automatically** |
| Parking Lot authorization state | This selected task is no longer in Parking Lot. Private Identity and the other five candidates remain unselected and unauthorized |

## Historical / Superseded — Valid Set 1 Dev-Server Performance Hard Stop

Status: **DEVELOPING — MATERIAL HARD STOP AT VALID FINAL PERFORMANCE SET 1**.
...
| Task Status | **DEVELOPING — Material Hard Stop because valid Final Performance Set 1 failed the fixed threshold; correction remains local and unpublished** |
| Owner Policy | **Confirmed 2026-08-21, latest:** perform bounded sanitized diagnosis of the exact local Supabase project, use at most two conditional recovery approaches, then restart the two-set direct-URL certification only after Auth/REST readiness and residue `0`. A valid Performance set failure requires immediate Hard Stop with no retry, further diagnosis/correction, later gate, Commit, Push, Deploy, alias change, or Promotion |
| Intended Behavior | Parent sees only on-demand `submitted/approved/rejected` exact-group programs while `draft` stays hidden; Coach sees exact-group Level range, child nickname, individual Level, and exact-slot program/status/modal; Admin Review defaults to the full Bangkok current month and performs validated server-side range filtering, range-scoped stats, explicit read errors, and bounded results |
| Root Cause | **Original Admin Review Runtime Root Cause proven locally:** the old all-history path loaded up to 800 programs, built an oversized schedule-slot `.in()` request, and ignored the resulting `URI too long` read error. **Prior Base invocation Root Cause confirmed by Owner:** worktree leaf `base-worktree` conflicted with config project id `New-Athlete-Badminton-School`. **REST blocker classification B:** stale/incomplete exact-project local stack; old PostgREST logs showed successful PostgreSQL connection/schema-cache load, DB was healthy, while CLI status reported PostgREST and multiple exact-project services stopped. Exact-project recovery restored readiness. **Current blocker:** valid Set 1 performance threshold failure; no further Root Cause diagnosis is authorized. Historical Coach variance remains **Unknown** |
| Branch | `spike/next-major-security-upgrade` |
| Local / Remote HEAD | `cbb9203fb5bf2581bcca419e2c4c46f6c772dbf1` / same upstream; prior published Application base remains `7c32e924fdd76d88ce853dfde531f84a2123bc22`; UAT correction has no commit |
| Ahead / Behind | `0/0` |
| Source Complete | **No** — Owner-authorized local correction exists, but mandatory final Performance certification did not complete and publication is prohibited |
| Tests Passed | **No for the required complete gate.** Accepted historical focused evidence remains: `test:schedule-learning-details` `17/17`; `test:admin-teaching-program-review` `10/10`; immediate current-month → historical → current-month E2E `2/2` twice with retry/skip/unexpected/flaky `0` and residue `0`; TypeScript passed. Valid Set 1 completed but failed Performance; Set 2 and all later required gates were therefore not run |
| Committed / Pushed | **No / No for this correction**; staged paths remain `0` |
| Current / Pushed Source | Local uncommitted UAT correction on documentation HEAD `cbb9203fb5bf2581bcca419e2c4c46f6c772dbf1` / no corrected Source pushed |
| Functional / Test / Documentation / Migration / Config Files | Owner-authorized local task set `7 / 3 / 3 / 0 / 1`; total unique task paths `14`; three authorized new paths; path `15` absent; no dependency or lockfile change |
| Scope Expansion / Scope Breach | **Owner-authorized UAT correction within the fixed 14-path contract / No** |
| Migration Source / Applied | **None / No** |
| Environment Changed | **Application/remote Environment: No.** Local tooling effects: existing Docker Desktop and CLI `2.115.0` operated only the disposable exact-project stack. Recovery Approach 2 stop/start/reset ran once; the recreated PostgREST container uses the image pinned by that existing CLI (`v16.1` versus stale container `v14.1`). No CLI install/upgrade, setting, secret, linked Supabase, remote Environment, or remote Supabase access occurred |
| Feature Enabled / Allowlisted | **No change / No change** |
| Performance Baseline | Comparison base Application SHA `7c32e924fdd76d88ce853dfde531f84a2123bc22`; required two complete sets, actor order User/Coach/Admin Schedule plus bounded Admin Review, warm-up `1`, measured `5` per side/actor |
| Performance Result | **FAIL — valid Set 1 completed Current/Base with residue `0/0`.** User `1695.2/1250.5 ms` = `+444.7 ms` (`+35.56%`); Coach `2078.9/1817.3` = `+261.6 ms` (`+14.39%`); Admin Schedule `2173.5/2190.0` = `-16.5 ms` (`-0.75%`); Admin Review current `1584.6/1261.9` = `+322.7 ms` (`+25.57%`); Admin Review historical `1541.5/1522.1` = `+19.4 ms` (`+1.27%`). User, Coach, and Review current met both `>10%` and `>=100 ms`; Set 2 was prohibited and not run |
| Query-call Budget | Architecture in local Source: Parent initial program `0`, Parent click auth plus `3` bounded reads; User/Coach Level fixed; Coach adds at most `1` exact-slot bounded program read; Admin Schedule modal `0/0`; Admin Review uses one server-side relation-filtered bounded program read and does not preload all-history. Final certification was not completed, so no overall Performance PASS is claimed |
| Initial Payload Before / After | Valid Set 1 Current/Base median bytes: User `2,788,937/2,797,506`; Coach `2,800,251/2,807,891`; Admin Schedule `2,793,289/2,801,853`; Review current `2,790,382/2,801,210`; Review historical `2,793,068/2,801,214`. Browser/API counts stayed `18/0`, `18/0`, `19/1`, `18/0`, `18/0`; Parent initial program request/content stayed `0/0` |
| Deployed / Promoted | **No new correction artifact / No** |
| Staged Artifact / Exact SHA | Previous artifact `dpl_52gKBAoDW42zRcbGfsiKv9RG2EWE` / `7c32e924fdd76d88ce853dfde531f84a2123bc22` is **Owner-rejected evidence**, retained and prohibited from Promotion; no replacement artifact exists |
| Staged Smoke / Logs | **Not run for a replacement artifact** |
| Alias Before / After | Production aliases remained on `dpl_9bJyCeRVqy8wFz38zXqsjsCkB1JV`; no alias command or traffic move occurred |
| Production Active / Owner UAT | **No for this correction / previous artifact UAT FAIL; replacement UAT not available** |
| Controlled Write UAT | **Not run** |
| Data Repaired / Production Data Changed | **No / No**; recovery and Performance fixtures were confined to the disposable local stack and both Set 1 sides reported residue `0` |
| Customer Impact / Financial Impact | **No Production customer impact / None**; correction is unpublished. Commercial project note remains item 1 only = `12,000 บาท` and does not change application pricing, wallet, or finance |
...
| Bounded Correction Attempts | Existing Product date-state correction remains `1/1`; no second Product/Test/Config correction occurred. Local recovery Approach 1 `0` (not applicable), Approach 2 `1/1` and passed. Valid Performance Set 1 ran once with no retry and failed; Set 2 count `0` |
| Documentation Drift | **No after this safe handoff** — prior incomplete invocations remain Historical/non-counting; current authority records the valid Set 1 failure |
| Blocker | **Owner authorization required.** Valid Final Performance Set 1 exceeded the fixed threshold for User, Coach, and Admin Review current-month; current policy forbids retry, diagnosis/correction, Set 2, later gates, Commit, Push, or artifact creation |
| Remaining Work | Owner decides whether to authorize a new diagnosis/correction/certification action. No technical continuation is permitted under the current authorization |
| Task Done | **No** |
| Next Gate / Next Action | **Await Owner direction. Do not retry or diagnose Performance, change Product/Test/Config, run Set 2 or later gates, Commit, Push, Deploy, create an artifact, change aliases, or Promote** |
...
| Tests Passed | **Yes** — focused `21/21`, protected adjacent deterministic suites, TypeScript, zero-warning ESLint, mojibake, Production build, readiness, diff checks, authenticated staged desktop/mobile, performance, and post-Promotion Production identity/health/static/auth/API/log/data gates pass |
| Committed / Pushed | **Yes / Yes** — corrective Functional/Test commit `21e45eed576014b8989ecc697c624ff2efc9122a`; containing Production-closeout documentation commit published normally without force |
| Current / Pushed Source | `21e45eed576014b8989ecc697c624ff2efc9122a` |
| Deployed | **Yes — exact Owner-passed artifact Promoted without rebuild** |
| Deployment ID | Production-active `dpl_FG52gCxZhcfKsUdHuxSQ1eBwsGqq`; rollback candidate `dpl_9V1fwFzFFgcuKUXHueFGFrDa4gED`; rejected old `dpl_8jqKAnStXm1CxNXNu4x1kCuCHpx4` |
| Promoted Artifact / SHA / URL | `dpl_FG52gCxZhcfKsUdHuxSQ1eBwsGqq` / `21e45eed576014b8989ecc697c624ff2efc9122a` / `https://new-athlete-badminton-school-p5xn0jjnc-aachanin1s-projects.vercel.app` — `READY`, target `production`, exact Git/functional/tested SHA; creation/build/ready timestamps unchanged |
...
| Current Production | All four established Production aliases point to `dpl_FG52gCxZhcfKsUdHuxSQ1eBwsGqq` / Source `21e45eed576014b8989ecc697c624ff2efc9122a` |
...
| Production Active | **Yes — corrective Source is current through the exact Owner-passed artifact** |
| Owner UAT | **PASS** for exact `dpl_FG52gCxZhcfKsUdHuxSQ1eBwsGqq` / `21e45eed576014b8989ecc697c624ff2efc9122a` |
| Production UAT | **Automated Production verification passed; second manual UAT not run/not required because the exact no-rebuild artifact is active** |
| Controlled Write UAT | **Not run / not required** |
...
| Production Verification | Canonical/custom roots `200`; protected Vercel team aliases retained expected SSO `302`; `/api/health` and real static asset `200`; anonymous Admin Notifications `307` to Login; anonymous Follow-up API `401`; bounded post-Promotion logs GET-only with error/fatal/5xx/mutation `0` |
| Promotion Invocation / Retry / Rebuild / Redeploy / New Deployment | `1 / 0 / 0 / 0 / 0` |
...
| Customer Impact / Financial Impact | **Approved corrective Admin UI is Production-active; no customer-data or financial impact / None** |
| Rollback Candidate / Used | `dpl_9V1fwFzFFgcuKUXHueFGFrDa4gED` / **Not used** |
| Documentation Drift | **No after the containing closeout documentation commit is pushed** |
| Blocker | **None** |
| Remaining Work | **None for this task** |
| Task Done | **Yes** |
| Next Gate / Next Action | **Await Owner selection; do not start Parking Lot automatically** |
...
### Owner UAT PASS and Exact Promotion Evidence

- Owner passed only `dpl_FG52gCxZhcfKsUdHuxSQ1eBwsGqq` / Source
  `21e45eed576014b8989ecc697c624ff2efc9122a`. The rejected artifact
  `dpl_8jqKAnStXm1CxNXNu4x1kCuCHpx4` was not Promoted.
- One `vercel@58.9.5 promote dpl_FG52gCxZhcfKsUdHuxSQ1eBwsGqq` invocation ran
  from `2026-08-12T14:49:10.8255723Z` to `14:49:17.6565074Z` and returned exit
  `0`. Retry, build, rebuild, redeploy, new deployment, separate alias mutation,
  and rollback counts were `0`.
- Deployment identity remained `createdAt 1786543374622`, `buildingAt
  1786543375512`, `readyAt 1786543463764`, with Git/functional/tested SHA all
  `21e45eed576014b8989ecc697c624ff2efc9122a`. All four established Production
  aliases now resolve to this exact deployment.
- Pre/post SELECT-only tracking manifests were identical: campaigns/batches/items/
  requests `1/1/125/4`, active `1/1`, pending/sent/excluded `115/6/4`, completed/
  processing/request recipients `4/0/6`, linked/current Sent `6/6`, dynamic
  actionable `77`, and anomalies `0`. Developer-created Requests, Notifications,
  and tracking/business rows changed were all `0`.
...
| Branch | `spike/next-major-security-upgrade` |
| Local HEAD | Containing 2026-08-06 safe-handoff documentation commit; final Application Source content remains functional parent `5d7c5c675f2dd5818e5b7116848385624cd8969a` after diagnostic-removal commit `5993d9d58b60493c9b8064602009b57548ed3898` |
...
| Source Complete | **No for the newly approved behavior. Historical-month blocking and on-demand assignment history were not implemented because timeout attribution ended Unknown** |
| Tests Passed | **No for the new behavior; no new regression or final release suite ran after the mandatory diagnostic Hard Stop. Diagnostic-removal verification passed focused zero-warning ESLint, TypeScript, and `git diff --check`. Prior functional Source `5d7c5c...` retains its earlier `167` deterministic assertions/build evidence only** |
| Performance Gate | **Not run for a final uninstrumented correction. Diagnostic artifact warm-up plus `20/20` current samples all reached authoritative readiness; browser wall min/P50/P95/max was `2.064/2.398/2.767/3.500s`, population stable at `957` learner-sessions / `310` slots / `1` roster page. This is attribution evidence, not Performance PASS. The old three timeouts remain uncorrelated; July/history/mobile/navigation gates did not run** |
| Completeness / Calls | Diagnostic current samples were stable at roster `957`, slots `310`, coaches `55`, roster pages `1`; supporting reads were `12` calls / `11` batches with Legacy `355`, groups `358`, levels `347`, definitions `70`. Initial assignment-memory/history requests were `0`; Vercel inventory was exactly `21` GET Assignment route requests (`1` warm-up + `20` samples), all HTTP 200, no N+1 was introduced by diagnostic logging |
| Committed | **Yes — diagnostic commit `4779675e071d9c474f0cf9d1584f87685ac215bb`, diagnostic-removal commit `5993d9d58b60493c9b8064602009b57548ed3898`, prior functional/test commit `5d7c5c675f2dd5818e5b7116848385624cd8969a`, and containing documentation safe-handoff commit** |
| Pushed | **Yes — authorized diagnostic/removal and containing safe handoff after normal push** |
| Current Source | Final Application file content restored exactly to functional Source `5d7c5c675f2dd5818e5b7116848385624cd8969a`; Production remains Source `03d08a93e77189d56b733bda009d9526400fa9b3` |
| Pushed Source | Diagnostic/removal history pushed; final Application content equals `5d7c5c675f2dd5818e5b7116848385624cd8969a` |
| Deployed | **Diagnostic/prior staged Production-target artifacts only; all blocked from Owner UAT/Promotion. No newly approved task behavior is deployed or Production-active** |
| Deployed Source | Temporary diagnostic staged-only `4779675e071d9c474f0cf9d1584f87685ac215bb`; prior candidate staged-only `5d7c5c675f2dd5818e5b7116848385624cd8969a`; Production `03d08a93e77189d56b733bda009d9526400fa9b3` |
| Deployment ID | Diagnostic-only `dpl_CPniCRugkTZimT9xGVRJrGgGFcj2`, URL `https://new-athlete-badminton-school-3hsp8748m-aachanin1s-projects.vercel.app`, `production/READY`, region `icn1`, aliases `[]`, exact Source `4779675e071d9c474f0cf9d1584f87685ac215bb`; temporary instrumentation is removed from branch Source and this artifact is **blocked/ineligible for Owner UAT or Promotion** |
| Rejected / Blocked Artifacts | Diagnostic-only `dpl_CPniCRugkTZimT9xGVRJrGgGFcj2`; performance-failed `dpl_9MhH8A612dc3nXZBZBAeTPcsz7mV` and `dpl_EY91eHqAk58Dqc7akvsUNLztsNjM`; runtime-failed `dpl_DBnGPPV6ioBt4jpkonC4TMXqL173`; blocked `dpl_9RE8BF4LL1awvGfWH5V2nTsCzFDm`; historically rejected `dpl_8sYvgzXSEZfUKgfi6fd2ViQrxinJ`. Evidence only; never Promote |
...
| Owner UAT | **Not started. Owner supplied an authenticated Head Coach session for diagnostic verification only; no Owner UAT handoff is permitted after the Unknown-attribution Hard Stop** |
| Production UAT | Not run; task is not Production-active |
| Controlled Write UAT | Not run / prohibited |
| DB Fixture / DB Write | `0 / 0` |
| Data Repaired | No |
| Production Data Changed | **Task-attributable No. Diagnostic-window totals were unchanged: notifications `25,490`, activity logs `11,256`, assignment groups `1,552`, memberships `3,554`; exact-window deltas were all `0`** |
| Customer Impact | None direct; task Source is not Production-active |
| Financial Impact | None |
| Functional / Test / Documentation / Migration / Configuration Changes | Final content delta this round `0 / 0 / 3 / 0 / 0`; temporary diagnostic touched `3` allowlisted functional paths and was fully removed in commit `5993d9d...` |
| Scope Expansion | No |
| Scope Breach | No |
| Documentation Drift | **No after this diagnostic Material Hard Stop safe-handoff commit is published** |
| Blocker | **Timeout attribution is Unknown. The prior three failures have no recoverable correlated phase trace; new instrumentation completed 20/20 samples and therefore cannot prove Browser/sampler or Assignment-specific causation. Scope requires a Hard Stop for Unknown/shared attribution** |
| Remaining Work | Owner decides whether to authorize a separate instrumentation/reproduction scope or accept the Unknown and amend the gate. Do not implement the new month/history behavior, run Owner UAT, create a final artifact, Promote, alias, or mutate data automatically |
| Task Done | **No** |
| Next Gate / Next Action | **Owner decision after Unknown timeout attribution; all staged artifacts remain blocked and unpromoted** |
...
checked out, stashed, or normalized. Lifecycle migration SHA-256 remains
`47D1B3FD43F8E9F115AD72917C87BDD2DFE3D83FECB0FCE4419DF3593CC4ECC8`.
Diagnostic phase nearest-rank min/P50/P95/max in milliseconds was: proxy auth
`121.2/140.1/363.5/392.5`, proxy role `120.8/132.9/356.7/371.3`, shared layout
complete `131.4/173.3/378.6/1008.6`, primary roster/coaches
`888.4/952.6/1037.5/1872.9`, supporting reads
`218.6/253.1/300.2/471.4`, and Assignment Server render
`1248.6/1313.9/1525.2/2228.4`. All 20 traces completed successfully; one shared
attendance-notification phase reached `891.9ms` but no timeout occurred, so it is
not causal proof. Browser console warning/error was `0/0`; Vercel runtime error,
fatal, and 5xx were `0/0/0`. Supabase Auth/API records in the sampled interval
were successful reads; Postgres logs contained no correlated error. Exact browser
transferred bytes and the old timeout request/phase correlation remain Unknown;
no DOM proxy is reported as wire bytes. No Production write, DB fixture, repair,
migration command, environment, feature-control, allowlist, alias, or Promotion
action occurred.
...
Owner Preview UAT passed on `dpl_7xuum5V7aFNxMeYSFnLqD2H8kdbY`, URL
`https://new-athlete-badminton-school-pi4tpz8dp-aachanin1s-projects.vercel.app`,
at Application Source SHA `03d08a93e77189d56b733bda009d9526400fa9b3`.
Vercel's Promotion created derived Production deployment
`dpl_5KVSd4jqNB3tqYA1t9qHjb4VBHZC`, URL
`https://new-athlete-badminton-school-q0xng3m0d-aachanin1s-projects.vercel.app`,
with the same Source SHA. Owner accepted that derived artifact and the normal
Preview-to-Production rebuild, then passed authenticated Super Admin Production
UAT from screenshots and real use.

The Owner authorized two alias reassignments only. Both pinned Vercel CLI
`58.4.4` `vercel alias set` commands used the exact derived deployment hostname,
without `--force`, and exited `0`:

- `new-athlete-badminton-school-aachanin1s-projects.vercel.app` from
  `2026-08-03T14:35:11.0566087Z` to `14:35:13.8330551Z`.
- `new-athlete-badminton-school-aachanin1-aachanin1s-projects.vercel.app` from
  `2026-08-03T14:35:38.0910464Z` to `14:35:40.6823614Z`.

Alias inventory remained exactly eight rows. All four established Production
aliases now resolve to the accepted derived artifact: `www.newathleteschool.com`,
`new-athlete-badminton-school.vercel.app`,
`new-athlete-badminton-school-aachanin1s-projects.vercel.app`, and
`new-athlete-badminton-school-aachanin1-aachanin1s-projects.vercel.app`. No alias
was added or removed. No deployment appeared after the pre-alias deployment
baseline, and the accepted artifact remains `production/READY` with unchanged
created/building/ready timestamps
`1785766273206/1785766274341/1785766349724`.

Production root returned `200`, `/api/health` returned `200 application/json`,
real CSS `/_next/static/css/be7cc4444a49344a.css` returned `200 text/css`, and
unauthenticated `/admin/payroll` returned the expected `307` login redirect. The
two Vercel team aliases returned the expected protected `302` to Vercel SSO.
Bounded Vercel error/fatal/HTTP 5xx and database/auth/payroll failure queries
returned zero. Correctly parsed post-alias Supabase logs showed API/Auth entries
`0/0`, Postgres `2` informational `LOG` entries, and failures `0`.

Deterministic post-alias reruns passed Teaching Hours completeness `18/18` and
Payroll performance architecture `14/14`, including no row loss after 1,000,
Cake `5` rounds / `10` hours, Dome Private `1h`, truthful excluded wording, and
summary/detail equality. Owner Production UAT independently confirmed normal
Admin Payroll behavior. No Source, test, Migration, configuration, Environment,
feature-control, allowlist, or Production business data changed in the alias
convergence gate. Close Week was not invoked.

The release-process correction is now permanent policy: a Preview-to-Production
Promotion creates a distinct Production deployment/build. Future no-rebuild
exact-artifact releases must stage Production with `vercel --prod --skip-domain`,
...
| Task Status | **TASK DONE** |
| Branch | `spike/next-major-security-upgrade` |
| Local HEAD | Containing documentation/policy closeout commit; exact SHA is reported from Git in the final handoff |
| Remote HEAD | Equal to Local HEAD after the authorized normal push |
| Ahead/Behind | `0/0` in the published closeout state |
| Source Complete | **Yes — scoped Payroll Source and read model complete** |
| Tests Passed | **Yes — exact Source release suite passed; post-alias completeness `18/18` and Payroll performance `14/14`** |
| Performance Gate | **Passed — warm P95 `1.886s`, month-change P95 `1.347s`, detail P95 `0.605s`, max `1.886s`** |
| Accuracy Reconciliation | **Passed — Cake `5/10`, Dome Private `1h`, summary/detail equality, and no loss after 1,000** |
| Committed | **Yes — Application Source `03d08a93e771...`; containing closeout commit identified in the final handoff** |
| Pushed | **Yes — Application Source and containing closeout commit are pushed in the published state** |
| Current Source | `03d08a93e77189d56b733bda009d9526400fa9b3` |
| Pushed Source | `03d08a93e77189d56b733bda009d9526400fa9b3` |
| Source Changed in Alias Gate | No |
| Tests Changed in Alias Gate | No |
| Deployed | **Yes — Owner-accepted derived Production artifact** |
| Deployed Source | `03d08a93e77189d56b733bda009d9526400fa9b3` |
| Deployment ID | `dpl_5KVSd4jqNB3tqYA1t9qHjb4VBHZC`, `production/READY`, accepted by Owner |
| Owner Preview UAT | **Passed — `dpl_7xuum5V7aFNxMeYSFnLqD2H8kdbY` / `03d08a93...`** |
| Owner Production UAT | **Passed — accepted `dpl_5KVSd4jqNB3tqYA1t9qHjb4VBHZC` / `03d08a93...`** |
| Promotion Result | **Owner accepted the derived Production artifact and platform rebuild as the verified Vercel workflow** |
| Historical Promotion / Retry / Platform Rebuild | `1 / 0 / 1` |
| Alias-Gate Promote / Retry / Rebuild / Redeploy / Alias Set / Rollback | `0 / 0 / 0 / 0 / 2 / 0` |
| Alias Convergence | **Passed — all four established Production aliases point to the accepted artifact; inventory remains `8`** |
...
| Production UAT | **Passed by Owner with Super Admin on the accepted Production artifact** |
| Production Checks | Root `200`; health `200 application/json`; real CSS `200 text/css`; Payroll auth redirect `307`; protected team aliases `302` to Vercel SSO; bounded error/fatal/5xx/task-failure logs `0`; aliases `4/4` |
| Controlled Write UAT | **Not run / prohibited; Close Week was not invoked** |
| Close Week Invoked | No |
| Data Repaired | No |
| Production Data Changed | No |
| Financial Data Changed | No |
| Customer Impact | **Admin Payroll accuracy/performance correction is Production-active and Owner-verified; no customer data changed** |
| Financial Impact | None; no payroll row, rate, summary, or business data was written |
| Functional / Test / Migration / Configuration Changes in Alias Gate | `0 / 0 / 0 / 0` |
| Documentation / Policy File Count | `4` in the containing closeout commit |
| Scope Expansion | No |
| Scope Breach | **No by Developer; Owner accepted the Vercel result as a release-workflow correction, not a Source defect** |
| Documentation Drift | **No after the containing closeout commit is published** |
| Blocker | None |
...
Prior documented source context (state observed on 2026-07-29; retained as
historical evidence): current local/upstream/live-Remote Git metadata, the published request-size
fix and retained Local verification, the Owner-authorized fresh staged Deploy,
the Owner-accepted remote-builder CLI exception for this artifact, bounded Chrome
staged/Production-UAT evidence, read-only Vercel control-plane/runtime evidence,
the Owner-authorized exact-window Supabase SELECT attribution audit, and prior
documented release state. The current exact-HEAD artifact was `READY/STAGED` and
unaliased before Promotion, and is now `READY/PROMOTED` with all four established
Production aliases mapped to it. The bounded Head Coach staged UAT is **PARTIAL /
Owner-accepted**: session/role proof, desktop/mobile rendering, prior-digest
regression, Exact-membership precedence, and safety passed; Pending User
Reschedule, genuine Legacy-only fallback, Wallet, and Makeup had no natural row
but retain deterministic regression coverage. The canonical Production UAT page
also rendered safely. Its initial runtime gate Hard Stopped on seven concurrent
`POST /api/coach/assignment-groups` records, but the subsequently authorized
read-only attribution audit conclusively separated all seven from the UAT client:
the UAT navigation/RSC cluster was GET-only on fingerprint hash
`30E6AF2FB89ADE62`, while all POSTs and the other client's assignment-page GETs
used `F12B551451608526`. The four HTTP `200` requests aligned one-for-one with four
`save_coach_assignment_groups` activity rows from one other Head Coach actor;
three HTTP `500` attempts shared that external fingerprint and had no successful
activity rows. No evidence attributes any assignment mutation to Codex/UAT.
Production UAT and Controlled Write UAT therefore pass within the Owner-approved
natural-notification limitation. No browser retry, write/RPC, repair, Deploy,
Promotion, rollback, Source, Commit, or Push followed.
...
The prior
**RESCHEDULE-IN EXACT COACH ASSIGNMENT / LEGACY FALLBACK ISOLATION** task remains
Task Done. Its published request-size fix is functional commit
`8166d669165e1dc51e71897423c7aeab524d9050` under exact branch HEAD
`7b7dd912d46b28d4ca299c9221f53abe4c67d075`, tree
`b488c57e9eec3a1e746a2b9d9a37bbd8288b1e7e`. The older Production-target
artifact `dpl_7g4Kt6VrZKrzugttUCNrqVDa2nDM` remains `READY/STAGED`, unaliased,
...
Source/Test files. Documentation commit `7b7dd912d46b28d4ca299c9221f53abe4c67d075`
is published and local/upstream/origin/live Remote equality is `0/0`.

Owner authorized a fresh staged-deployment attempt and explicitly allowed
correction/rerun of an ephemeral validation helper for formatting/tooling errors
before deploy-process launch. Phase A used numeric ahead/behind parsing and
compatible instance SHA-256 APIs; helper correction/run/rerun counts were `1/1/0`.
Fresh Git, protected-file, project/linkage, exact-SHA duplicate, alias, and newer-
Production-artifact evidence passed. A validated temporary evidence file retained
the sorted preflight 100-ID list and eight alias mappings. The clean detached
worktree matched exact HEAD/tree and staged/untracked `0/0`.

Exactly one pinned `deploy --prod --skip-domain` process ran from
`2026-07-29T14:27:07.8449093Z` through `2026-07-29T14:28:49.0788429Z`, exit `0`,
and created `dpl_GWfmXNEHFQCeSQZZfqRh1BZnPg7M` at
`https://new-athlete-badminton-school-7zqvx0cel-aachanin1s-projects.vercel.app`.
Metadata proves exact SHA/tree, `production/READY/STAGED`,
`autoAssignCustomDomains=false`, and aliases `0`; created/building/Ready were
`2026-07-29T14:27:14.964Z`, `2026-07-29T14:27:16.669Z`, and
`2026-07-29T14:28:48.948Z`. Install, Next.js `16.2.6` compile, TypeScript, static
generation `91/91`, and build-error count `0` passed in `cle1`; project runtime is
Node `24.x` and functions region remains `icn1`. Exact build logs show the pinned
local invocation/inspection CLI was `56.5.0` while the remote Vercel builder ran
CLI `58.1.0`. That mismatch blocked the original Deploy gate, but Owner later
accepted remote builder CLI `58.1.0` as an artifact-specific exception and allowed
this artifact to proceed to a separately bounded Head Coach staged UAT.

Postflight inventory changed by exactly added ID
`dpl_GWfmXNEHFQCeSQZZfqRh1BZnPg7M`; the bounded window removed only prior oldest
ID `dpl_4sJBJPvPJTumPNYWywcTqSC4pvUw`. Pre/post hashes were
...
All eight alias mappings and alias hash
`BEC3771B0B721090AA765678B701EC66187FD1A7C33E866E241CD08EAA919644` remained
unchanged. Postflight helper correction/rerun counts were `2/2`: first for
PowerShell stderr `NativeCommandError`, then to distinguish the timestamped
remote CLI line from the untimestamped local banner. No deploy retry, rebuild,
redeploy, Promotion, alias mutation, application/Supabase access, or UAT occurred.
The disposable worktree was safely removed and unregistered.

For the Owner-confirmed-session retry, fresh Git/live-Remote, Source automatic-
write, artifact, deployment inventory, and alias gates passed. Source inspection
proved that the Coach layout permits only the two Owner-approved automatic
reminder generators on Coach/Head Coach render; both deliver through
`deliverCoachNotificationOnce()`. The assignment server page and memory helper are
SELECT-only, the client has no mount mutation, and its only assignment POST is
inside the explicit Save-button handler. Before navigation, the existing exact-
host `/coach` tab visibly proved `โค้ช Super Head Coach(หัวหน้า)`, the Head Coach-
only `แบ่งกลุ่มนักเรียน` menu, and unread badge `99+`. No new tab/profile or login
was used.

The exact `/coach/assign-groups` route opened once at desktop `1920x855`, with
reload/retry `0/0`, and rendered the real multi-branch assignment business page.
The prior digest `233653541`, `CoachAssignmentDataUnavailableError`, Server
Component, console, hydration, visible overlay, and horizontal-overflow errors
were all `0`. The same tab passed mobile `390x844` without reload, clipped text,
responsive crash, or overflow; its viewport override was reset and the Owner tab
was left open. Natural evidence showed a Legacy coach explicitly marked not
responsible while Exact groups and assigned coaches remained authoritative, so
Exact-membership precedence passed. Pending User Reschedule isolation, genuine
Legacy-only fallback, Wallet preservation, and Makeup preservation were **Not
observable — no natural representative row**; no data or UI state was created to
...
response was HTTP `200`; assignment Save POST, Save clicks, and non-notification
mutations were `0/0/0`; fatal/error/4xx/5xx were `0/0/0/0`. Notification delta is
**Unknown / Need verification — Direct Supabase prohibited**; possible data change
is limited to the expressly allowed natural reminder INSERT path. Read-only
Vercel postflight preserved artifact identity/state/zero aliases, bounded 100-ID
inventory count/hash/max-created/newest ID, all four Production aliases, and all
four branch Preview mappings exactly; deployment added/removed IDs were `0/0`.
Owner accepted the Partial staged UAT because the missing natural cases retain
deterministic regression coverage, then authorized one exact-artifact Promotion.
The pinned local CLI `56.5.0` command ran once from
`2026-07-29T15:30:02.7083065Z` through `2026-07-29T15:30:08.2740790Z`, duration
`5.566` seconds, exit `0`. Explicit GET postflight proved the same deployment is
`production/READY/PROMOTED`; SHA, URL, created/building/Ready timestamps, build,
and `autoAssignCustomDomains=false` are unchanged. The bounded deployment count/
hash/max-created remained `100` /
`C849ED9BFA716AF9F133098529203F3F922D459EF93A0FC5D6DF24284C229A0C` /
`1785335234964`, with added/removed IDs `0/0`. All four established Production
aliases moved from `dpl_61EJHnLchXS8KjcMXh3GEBR1jiF4` to
`dpl_GWfmXNEHFQCeSQZZfqRh1BZnPg7M`; all four Preview mappings are unchanged.
The prior artifact remains `READY` and listed as a rollback candidate. No Deploy,
rebuild, redeploy, retry, rollback, separate alias command, or manual alias
mutation ran. Production remains Active on the exact fix. The separately authorized
Production UAT rendered correctly on desktop and mobile and initially Hard Stopped
because its bounded runtime window contained seven assignment POST records and
three HTTP `500` responses. Owner then authorized one exact-window read-only
attribution audit. Vercel fingerprint evidence separated the GET-only UAT cluster
from every POST; exact-window Supabase SELECT evidence correlated all four
successful POSTs to four activity rows from one different Head Coach actor. The
three failed POSTs had the same external fingerprint and no success rows.
Production UAT is **Passed**, Controlled Write UAT is **Passed within the approved
natural-reminder limitation**, and Task Done is **Yes**. The unrelated external-
user HTTP `500` attempts are Parking Lot evidence only and are not authorized for
...
### Prior Database Root Cause and Local Source Result
...
### Owner-Approved Rendered Pending-Edit Correction Round

- Retained Owner-confirmed Production state before this correction: remote
  migration `20260730000000_fix_progressive_multibranch_booking.sql` is applied;
  the database accepts session-specific branches; Production multi-branch create
  UAT passed. Production pending-edit UI UAT then failed because the rendered
  calendar and summary showed only the booking's primary branch.
- Fresh Repository-only audit confirmed that the server page loads every
  `booking_sessions.branch_id` and `buildEditSessionsMap()` preserves each one,
  but Edit mode initialized `selectedBranchIds` from `editBooking.branch_id`
  alone. Draft sanitization then used that collapsed selection as its branch
  allowlist and could discard otherwise valid secondary-branch sessions. The
  former regression called `PUT /api/bookings` through `page.evaluate()` and did
  not exercise rendered Edit initialization or the Save button.
- Regression-first coverage now creates the real multi-branch pending booking,
  removes the edit-draft key, opens
  `/dashboard/booking?editBookingId=<booking-id>`, verifies both branch names in
  the calendar/header/session badges/summary, changes a session through the
  rendered calendar, clicks `บันทึกการแก้ไข`, verifies database primary branch,
  price, per-session branches and canonical slots, reloads Edit, and exercises a
  stale edit draft whose branch selection contains only the primary branch while
  its session map remains multi-branch.
- `booking-client.tsx` now derives the Edit selection as an ordered unique union
  of the valid primary booking branch followed by valid session branches. Edit-
  only draft reconciliation requires that union before session sanitization, so
  valid secondary-branch sessions survive. New-booking draft semantics, primary
  `bookings.branch_id`, API payloads, template/canonical-slot validation, pricing,
  payments, coupons, Ledger, Finance, and other business flows are unchanged.
- Pre-fix focused execution failed `1/1` exactly because the Calendar header
  contained only the primary branch; teardown residue was `0`. Post-fix focused
  execution passed `1/1`; focused single-branch rendered Edit passed `1/1`; the
  final full booking suite passed `11/11` with skipped, unexpected, flaky,
  retries, browser errors, and residue all `0`. TypeScript,
  zero-warning ESLint, mojibake `250`, Next.js build/static generation `91/91`,
  clean dev restart root/static HTTP `200`, and `git diff --check` passed.
- Functional File Count is `1`; Test File Count is `1`; Documentation File Count
...
- On 2026-07-29 Owner authorized one urgent read-only attribution audit for the
  seven assignment POST records in the exact canonical Production-UAT window.
  Vercel log/trace GETs and tightly bounded Supabase SELECTs over `activity_logs`,
  only involved `profiles`, and only-if-needed assignment groups were allowed;
  browser/session access, writes/RPC, repair, Source change, Commit/Push, Deploy,
  Promotion, rollback, alias mutation, UAT retry, and automatic Parking Lot work
  remained prohibited. Conclusive separation of every POST from the UAT session
  permits Production UAT acceptance and Task completion; otherwise the blocker
  remains.

- On 2026-07-29 Owner confirmed an existing canonical Production Head Coach
  session and authorized one bounded Production UAT on exact promoted artifact
  `dpl_GWfmXNEHFQCeSQZZfqRh1BZnPg7M`. Only natural reminder INSERTs from the two
  approved Coach-layout generators were allowed; Save, assignment POST, every
  other mutation, login/re-authentication, reload/retry, deployment, Promotion,
  Source change, Commit, Push, and direct Supabase/data inspection were prohibited.
  The gate Hard Stopped after bounded runtime logs showed forbidden assignment
  POST records and HTTP `500` responses despite zero Codex Save clicks.

- On 2026-07-29 Owner accepted the Partial staged-UAT evidence because the four
  unobservable natural cases retain deterministic regression coverage, authorized
  exactly one pinned Promotion of `dpl_GWfmXNEHFQCeSQZZfqRh1BZnPg7M`, and allowed
  only the alias/control-plane writes inside that command. Production UAT requires
  separate authorization.

- On 2026-07-29 Owner confirmed the exact staged Head Coach session was ready and
  authorized one bounded retry on the same artifact using only the existing tab.
  The same natural-notification-only write allowance and prohibitions remained in
  force; session/role proof was required before the single assignment navigation.

- On 2026-07-29 Owner accepted remote Vercel builder CLI `58.1.0` as an exception
  only for artifact `dpl_GWfmXNEHFQCeSQZZfqRh1BZnPg7M` while retaining local CLI
  `56.5.0`, and authorized one bounded staged UAT through an existing Head Coach
  Chrome session. Only natural reminder INSERTs from
  `createCoachCheckinWindowNotifications()` or
  `createCoachAttendanceGapNotifications()` through
  `deliverCoachNotificationOnce()` were allowed. Login/re-authentication, Save,
  assignment POST, every other mutation, reload/retry, Direct Supabase access,
  Deploy/rebuild, Promotion/alias movement, Source/config change, Commit, and Push
  remained prohibited. Any login redirect or inability to prove Head Coach role
  required an immediate Hard Stop.

- On 2026-07-29 Owner authorized a fresh staged-deployment attempt from exact HEAD
  `7b7dd912d46b28d4ca299c9221f53abe4c67d075`, allowed correction/rerun of only
  ephemeral validation helpers for formatting/tooling errors before deploy launch,
  and authorized at most one pinned Vercel `deploy --prod --skip-domain` process.
  After launch, retry/force/rebuild/redeploy/rollback remained prohibited. The
  artifact had to pass exact identity, `production/READY/STAGED`, zero aliases,
  unchanged mappings, and remote build requirements including Vercel CLI `56.5.0`.
  Promotion, application/browser access, staged UAT, Supabase/data access, Source/
  config change, Commit, and Push remained prohibited.

- On 2026-07-29 Owner approved at most one new Production-target staged
  deployment from exact HEAD `7b7dd912d46b28d4ca299c9221f53abe4c67d075`
  using only the pinned Node/Vercel CLI entrypoint and `deploy --prod
  --skip-domain`. Exact-SHA Preview artifacts were allowed; a pre-existing exact-
  SHA Production `READY/STAGED` artifact, any Gate/build mismatch, or any need to
  retry required a Hard Stop. Promotion, alias/domain mutation, application or
  Supabase access, UAT, Source/config change, Commit, and Push were prohibited.
  The gate Hard Stopped locally before deploy invocation when the immediate Gate
  script rejected literal tab-delimited `0\t0` ahead/behind output. Read-only
  diagnosis confirmed normalized `0/0`, but the no-retry rule remains controlling.
...
### Historical / Superseded Project Matrix — Completed Reschedule-In Exact Coach Assignment / Legacy Fallback Isolation

State observed at the prior task closeout on 2026-07-29; this matrix is retained
as history and does not override the Current Active Work matrix above.

| Field | Current value |
| --- | --- |
| Active Task | `NONE` |
| Task Status | **DONE — SOURCE/TEST COMMITTED/PUSHED; OWNER-ACCEPTED PARTIAL STAGED UAT COMPLETE; EXACT ARTIFACT PROMOTED AND PRODUCTION ACTIVE; CANONICAL PRODUCTION RENDER/SAFETY PASSED; READ-ONLY ATTRIBUTION PROVED ALL SEVEN ASSIGNMENT POSTS WERE CONCURRENT OTHER-USER TRAFFIC.** Four HTTP `200` requests correlated one-for-one with successful activity rows from one different Head Coach actor; the three HTTP `500` attempts shared the same external client fingerprint and are an unauthorized Parking Lot item |
| Branch | `spike/next-major-security-upgrade` |
| Local HEAD | `7b7dd912d46b28d4ca299c9221f53abe4c67d075`, tree `b488c57e9eec3a1e746a2b9d9a37bbd8288b1e7e`, parent functional commit `8166d669165e1dc51e71897423c7aeab524d9050` |
| Remote HEAD | Upstream, origin-tracking, and fresh live GitHub branch all equal `7b7dd912d46b28d4ca299c9221f53abe4c67d075` |
| Ahead/Behind | `0/0`; Phase A parsed the two values numerically rather than comparing raw whitespace |
...
| Documentation Drift | No after this local-only reconciliation. Earlier safety/session/runtime Hard Stops remain preserved as dated history. Current state distinguishes the original remote-builder CLI blocker, Owner's artifact-specific exception, accepted Partial staged-UAT coverage, exact Promotion, current Production aliases, successful Production rendering, the initial runtime-log Hard Stop, and its later conclusive read-only attribution resolution |
...
| Source Complete | **Yes — committed, pushed, and present in the promoted Production-active artifact.** The published Plan A semantics remain unchanged. `src/lib/coach-student-memory.ts` batches only the proven failing exact-membership lookup at 100, deduplicates IDs, combines rows, and preserves fail-closed batch context. No Legacy fallback or silent error suppression was added |
| Tests Passed | **Yes for retained functional/build verification and canonical Production render/safety; staged business-case coverage Partial / Owner-accepted.** Retained Local verification passed Coach `33/33`, Admin `38/38`, Wallet `17/17`, notification `26/26`, TypeScript, zero-warning ESLint, mojibake `250`, and Next.js build/static generation `91/91`. Remote `npm ci`, Next.js `16.2.6` compile, TypeScript, and static generation `91/91` passed with build-error count `0`; Owner accepted builder CLI `58.1.0` only for this artifact. Production desktop `1920x855` and same-tab mobile `390x844` rendered without the prior digest, console/hydration/visible error, or overflow, and Exact precedence was observable. The exact-window attribution audit proved the seven concurrent POSTs were not from UAT |
...
| Committed | **Published Source: Yes. Current gate documents: No.** Functional commit `8166d669165e1dc51e71897423c7aeab524d9050` contains exactly the approved two Source/Test files; documentation publication commit `7b7dd912d46b28d4ca299c9221f53abe4c67d075` is its child. The current three documentation files remain local-only and unstaged |
| Pushed | **Published Source: Yes. Current gate documents: No.** Local/upstream/origin/live Remote equal `7b7dd912...`; this gate made no push |
...
| Staged Deploy Gate | **Owner-accepted for this artifact only.** Phase A helper correction/run/rerun was `1/1/0`. Exactly one pinned `deploy --prod --skip-domain` process ran, exit `0`; invocation/process/control-plane-command counts are `1/1/1`. Owner later accepted remote builder CLI `58.1.0` as an artifact-specific exception while local invocation/inspection remained `56.5.0`. Retry/force/redeploy/rebuild/rollback counts remain `0/0/0/0/0` |
| Vercel inventory | Promotion pre/post and Production-UAT postflight deployment count/hash/max-created were unchanged at `100` / `C849ED9BFA716AF9F133098529203F3F922D459EF93A0FC5D6DF24284C229A0C` / `1785335234964`; added/removed IDs were `0/0`, the target remained newest, and newer conflicting Production artifacts were `0`. Alias count/hash after Promotion and after UAT remained `8` / `C95897ED7724906A94437688EE2C858C1D4867F5F5E924E5FD4960F5D88C9D02`. Missing/extra/wrong Production mappings were `0/0/0`; all four branch Preview mappings were unchanged |
| Exact-SHA Preview | Git Preview `dpl_o3jCUwo95Mt8hHSQm3Wrx7QPnbbx`, `preview/READY/STAGED`, URL `https://new-athlete-badminton-school-7xlv2rfz6-aachanin1s-projects.vercel.app`, remains allowed and unchanged with the `spike/next-major-security-upgrade` branch alias; it is not a Production-target artifact |
| Artifact Build | **Passed with Owner-accepted artifact-specific CLI exception.** Pinned local invocation/inspection CLI `56.5.0`, project Node `24.x`, Next.js `16.2.6`, `npm ci`, compile, TypeScript, build traces, outputs, and static generation `91/91` passed in `cle1`; configured functions region remains `icn1`; build-error count `0`. Owner accepted exact remote log `2026-07-29T14:27:18.102Z Vercel CLI 58.1.0` only for this artifact |
| Deployed | **Yes — exact Production-target artifact is `READY/PROMOTED` and Production-active.** No deployment or rebuild occurred during Promotion |
| Promoted | **Yes.** Exactly one pinned `vercel promote` process/control-plane command ran, exit `0`, duration `5.566` seconds. No retry, rollback, separate alias command, or manual alias API mutation occurred |
| Deployed Source | Exact committed/pushed HEAD `7b7dd912d46b28d4ca299c9221f53abe4c67d075`, tree `b488c57e9eec3a1e746a2b9d9a37bbd8288b1e7e`, parent functional fix `8166d669165e1dc51e71897423c7aeab524d9050`. No Source/config/environment diff was introduced |
| Deployment ID | `dpl_GWfmXNEHFQCeSQZZfqRh1BZnPg7M`; unique URL `https://new-athlete-badminton-school-7zqvx0cel-aachanin1s-projects.vercel.app`; `production/READY/PROMOTED`; exact SHA; `autoAssignCustomDomains=false`. Created `2026-07-29T14:27:14.964Z`, building `2026-07-29T14:27:16.669Z`, Ready `2026-07-29T14:28:48.948Z`; timestamps and retained build are unchanged. All four Production aliases now target this artifact; all four branch Preview mappings remain unchanged |
| Staged UAT | **PARTIAL / OWNER-ACCEPTED — page render and safety passed; some business cases were not observable but retain deterministic regression coverage.** The existing exact-host staged `/coach` tab visibly proved `โค้ช Super Head Coach(หัวหน้า)`, the Head Coach-only `แบ่งกลุ่มนักเรียน` menu, exact hostname, and unread badge `99+` before navigation. The exact assignment route opened `1` time, with reload/retry `0/0`. Desktop `1920x855` and same-tab mobile `390x844` passed: no digest `233653541`, `CoachAssignmentDataUnavailableError`, Server Component/console/hydration/visible error, responsive crash, clipped text, or horizontal overflow. Branch-scoped cards rendered. Natural evidence showed a Legacy coach explicitly marked not responsible while Exact groups remained assigned, proving Exact precedence. Pending User Reschedule, genuine Legacy-only fallback, Wallet, and Makeup were `Not observable — no natural representative row`. Canonical runtime GET/HEAD/POST/PUT/PATCH/DELETE were `25/0/0/0/0/0`; assignment Save POST and Save clicks were `0/0`; fatal/error/4xx/5xx were `0/0/0/0` |
...
| Production Active | **Yes — all four established Production aliases continue to serve exact artifact `dpl_GWfmXNEHFQCeSQZZfqRh1BZnPg7M`.** Production UAT did not alter deployment or alias state |
| Production UAT | **Passed.** Existing canonical Head Coach role/session proof passed before one route navigation. Desktop `1920x855` and same-tab mobile `390x844` passed without digest `233653541`, `CoachAssignmentDataUnavailableError`, Server Component/console/hydration/visible error, clipped text, or overflow; Exact precedence was observable. Bounded exact-artifact logs from `2026-07-29T15:50:15.407Z` through `2026-07-29T15:52:53.953Z` contained GET/HEAD/POST/PUT/PATCH/DELETE `30/0/7/0/0/0`, but sanitized fingerprint evidence conclusively separated the GET-only UAT client from all seven POSTs. The four HTTP `200` requests correlated one-for-one by timestamp/duration with four activity rows from one different Head Coach actor; the three HTTP `500` attempts shared that external fingerprint. Route/reload/retry and Codex Save/control-change counts remained `1/0/0` and `0/0` |
| Controlled Write UAT | **Passed within Owner-approved natural-notification limitation.** No assignment or non-notification mutation is attributable to Codex/UAT. PUT/PATCH/DELETE were `0/0/0`; all seven assignment POSTs were concurrent other-user traffic. Pending User Reschedule, genuine Legacy fallback, Wallet, and Makeup remain `Not observable — Owner-accepted deterministic regression coverage`. Notification delta remains **Unknown / Need verification** because it was not inspected and no scope expansion was authorized |
| Data Repaired | No |
| Production Data Changed | **By Codex/UAT: No assignment or non-notification mutation; possible approved natural reminder remains Unknown / Need verification. By external users: ordinary assignment activity observed.** Four successful external assignment saves produced four matching activity rows; three external attempts returned HTTP `500`. No repair occurred |
| Customer Impact | **Exact fix is Production-active and canonical Production UAT passed.** Four ordinary successful assignment saves by another Head Coach were observed during the window. Three failed external save attempts are separated into an unauthorized Parking Lot item; their cause and any user-facing impact were not diagnosed in this bounded attribution gate. No financial/payroll impact was observed |
...
| Blocker | None for the completed Active Task |
| Remaining Work | None within this task. The three external HTTP `500` assignment-save attempts and local residual-Junction cleanup remain separate Owner-selection items |
| Task Done | Yes |
| Next Gate / Next Action | Await Owner selection. Do not start the external assignment-POST/HTTP `500` Parking Lot diagnosis, retry UAT, repair data, clean the residual Junction, or start another task automatically |
| Parking Lot authorization state | **Assignment Save HTTP `500` attribution is external, but cause diagnosis/fix is PARKING LOT — OWNER SELECTION REQUIRED; NOT AUTHORIZED TO START.** No other Parking Lot task is authorized |
