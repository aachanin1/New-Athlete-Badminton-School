...
## Current State — Task10 calendar, pagination and Family warning corrective

**READY FOR OWNER UAT.** The corrected source is published, its exact staged Production artifact passed read-only school-role smoke, and the separate local functional site is serving with fresh Owner cases. Owner retest is Pending; Task Done is No.

### Current Project Matrix

| Field | Current value |
| --- | --- |
| Active Task / Intended Behavior | Task10 — 22 September Owner findings: child-first full-month Kids calendar, independent family/legacy pagination, accurate Family Private post-Store warning. |
| Task Status / READY / Task Done | READY FOR OWNER UAT / Yes / No. Developer verification is not Owner PASS. |
| Owner Decision / Scope | Owner22September and delivery continuations authorize audit through normal commit/push, staged Production without customer aliases and focused Owner retest. No Promotion, activation or remote business write. |
| Changed Paths / Scope Expansion / Breach | Published corrective Functional4 / Tests3 / Docs3 =10, including two explicitly approved new calendar files. This delivery closeout Functional0 / Tests0 / Docs3. Config/Dependencies/Migrations0. Expansion0; breach0 this corrective. Historical packaging/source-exposure breach remains recorded. |
| Protected Policy / Blast Radius | Makeup dialog/list and Family Schedule warning presentation; Adult/Private shares calendar presentation only. API/RPC/source selection, N/M/D/quota/identity, Family atomicity, Reschedule>=12h, Wallet>48h, same-month/ten-month, pricing/payment/attendance/payroll unchanged. /admin/schedules unchanged. |
| Branch / Upstream | spike/next-major-security-upgrade / origin/spike/next-major-security-upgrade. |
| Local HEAD / Remote HEAD / Ahead-Behind | Pre-closeout live audit24September02:55UTC: both1fba7bab987e8455824889563604063813e08855 /0/0. The containing Docs-only closeout commit is its successor; exact final HEAD/live remote/index/worktree are recorded in private final-delivery.json and the delivery report, avoiding recursive self-reference. Application/artifact SHA remains fixed below. |
| Index / Worktree / Documentation Commit | Pre-closeout indexempty, only Docs3 dirty. Complete Docs3 staged diff and consistency matrix are required before normal closeout commit/push; final publication evidence records the containing commit and clean state. No replacement artifact for documentation-only changes. |
| Source Complete / Current Source / Pushed Source | Yes /1fba7bab987e8455824889563604063813e08855 /same. Exact10-path source commit passed complete staged review and EOL normalization proof. No application/test change during delivery. |
| Tests Passed / Retained22September | Yes: final-byte Task10 79/79, Booking23/23, Makeup5/5, Wallet45/45, Admin state39/39, retrospective38/38; TypeScript/lint/mojibake and filtered Next build passed. Counts overlap and are not summed. No22September business suite rerun24September; old148 not fresh. |
| Fresh24September Checks | Actual Preview/staged input-worker-output manifests, health/assets/logs; authenticated staged both tabs/search/pagination/month/reload;7 committed-build local read-only UI checks, assets/roles/390px; physical bindings, Owner-row freshness, source/build hashes. Final documentation diff/encoding/scope are recorded separately. |
| Retained Local Transaction Preflight | 22September12 real-build UI/DB checks: family17 pagination15/2 versus Adult1; family-only/legacy-only/mixed/empty; actual attendee/template/source, used1/remaining4 after reload; whole-unit Family Store/Redeem2members/1credit/1target; true ineligible unit warns/denies. Owner rows and financial invariants unchanged. |
| Retained Owner UAT Baseline | Owner22September reported old2a1ac266 local transactions and staged read-only navigation passed with three findings. This accepts neither new bytes nor new artifact. A1/A2 and earlier rounds remain historical. |
| Committed / Pushed | Application Yes /Yes, normal commit1fba7bab on24September. Docs-only successor is identified separately in final publication evidence. |
| Local Build / Inputs | Serving PXUCkAh-yTw4DI3U0jEs3, Windows Next16.3.3/Node24.16; exact committed1fba source,493 Git inputs verified fresh02:55:06UTC. Generated next-env.d.ts recorded separately. Build completed01:50:13UTC/exit0 and was not rebuilt on resume. Separate artifact/environment from staged. |
| Config / Protected Hashes | 483 tracked Gate0 files outside corrective allowlist unchanged;7 source/test files still match tested hashes. Package/lock/config/AGENTS/API/RPC/migration bytes frozen. No Git config change. |
| Preview | READY dpl_2gzzT7vfHgwpeFTwmYkQ2kA7oWKL /exact1fba SHA; https://new-athlete-badminton-school-8rep0xibc-aachanin1s-projects.vercel.app . Actual worker363inputs/output219 verified, source serialization and tool-generated differences classified;44GET/40assets, healthJSON200/ok, scoped errors/5xx no matches. |
| Staged Artifact / Deployed Source | READY dpl_5bJmN6piCPmThycQEBSr9Rvqj2MF /1fba7bab987e8455824889563604063813e08855; https://new-athlete-badminton-school-l3qograeq-aachanin1s-projects.vercel.app . CLI production --prod --skip-domain, aliases0. Actual upload363/source hashes, worker363/output219, forbidden inputs/output0 and known audited literal matches0. Old2a1ac266 staged remains baseline only, not deleted. |
| Staged Fresh Smoke |24September44GET/40assets, healthJSON200/ok; school SuperAdmin both tabs, Review25rounds15/10 and Makeup26learners15/11, search/empty/clear, August/reload/September confirmed02:44–02:51UTC. Read-only UI operations; no business mutation clicked. Windows check did not capture every network request. |
| Production / Rollback / Checks | Fresh24September02:30:53–02:31:25 before and02:38:56–02:39:03UTC after: all4 customeraliases still dpl_Gwx4XuRureXfQh4vhCUxPEtHECBa /99b70fe373bfaa14424e2163136719024e5f0b0b READY; rollbackavailable; healthJSON200/ok. productionBranchmain/protection unchanged. No routing/settings change. |
| Owner UAT / Production UAT / Controlled Write UAT | New Owner retest Pending /no new Production business UAT or acceptance /Developer-owned synthetic transaction preflight22September only;24September checks read-only except ordinary synthetic Auth sessions. |
| Promotion / Deployment | No Promotion or activation. New staged Production created without customer aliases. Preview is separate and is not the acceptance artifact. |
| Migration Source / Migration Applied | Definitions unchanged. M1–M5 applied earlier; fresh remote SELECT24September02:39:04UTC confirms all5 versions. No remote apply/repair; existing migrations used only by the approved new disposable harness earlier. |
| Remote Feature Enabled / Activation / Scheduler | Fresh24September02:39:04UTC: never_activated/rev0/effective_at+artifactNULL/allflagsfalse; one task10-expire-unpaid-bookings-v1 inactive; events0/worker runs0. No controls/cron writes. |
| Local UAT / Fixture State | http://127.0.0.1:3050/__uat ->Next3051 serving, HTTP200 final02:55UTC. Task10Calendar20260922 API58321/DB58322 physical container33aff73a/ownedvolume/workdir/network/AuthRESTStorage verified. Fresh Owner business rows match22September: multi/single uses0, Family credits0/descendants0, two participants ready for11October->12October. Owner cases not consumed by Developer. |
| Local Controls / Clock | Disposable active/rev1/pricing+makeuptrue/expiryfalse; croninactive, native business clock. Browser/Auth/Node real time; no global Date override.24September UI selects only remaining eligible September dates/not-started rounds. September entitlement expires at month end; no extension. |
| Owner Backend Reconciliation | Retained22September SELECT confirms old Owner Makeup1/remaining4 at25September17–19; KidsWallet20Oct->1Oct siblingunchanged; FamilyPrivate2exactmembers/one redeemed credit/one12Octtarget; legacyexpiry31Oct; History cancelled0active andverified1active/500baht. Selected rows unchanged09:43->11:46UTC. UI attribution Owner-reported; complete pre-Owner financial baseline Unknown. |
| Allowlisted / Permissions / Environment | No remote allowlist/permission/Auth/environment/secret/protection changes. Only verified local process bindings and synthetic roles; private accounts outside Git/deployment. |
| Production Active / Production Data Changed / Data Repaired | Task10 OFF at fresh read. No Developer Production business/financial write or repair. Earlier applied schema/bootstrap retained; unrelated customer traffic not audited. |
| Customer / Financial Impact | Customer artifact/routing unchanged. Synthetic identity/quota/credit and payment/coupon/allocation/finance invariants passed22September; Owner rows unchanged24September. No live financial action or whole-system historical financial audit claim. |
| Logs / Unknowns | New staged error/fatal and5xx query02:44–02:54UTC found no matching logs. Chrome console after reload/navigation showed0messages/no filter and3unclassified Issues improvements; bounded observation only. Retained dev Booking3/Makeup4 stream-close digest3299920112 and Task10reset-period fetch failure attributionUnknown. Historical ERR_ABORTED, source exposure and credential-validityUnknown remain; not harmless/securityPASS claims. |
| Cleanup / Serving | Controller6684/Next5476 command+ports verified24September; serving intentionally remains. Synthetic Owner/Developer/pagination fixtures retained separately, not residue0. No reset/reseed/deletion of54321/55321/56321/57321 or prior Owner3040/3041 data. Stop cause of earlier servicesUnknown. Stop/cleanup instructions in private UAT-CALENDAR.md require fresh PID/ownership verification. |
| Documentation Drift | Corrected stale safety-stop/serving/artifact/Ownerunused claims from fresh evidence. Historical failures/stops preserved. This Docs-only successor is distinct from fixed application/staged SHA. |
| Blocker / Remaining Work / Next Gate | No material delivery blocker. Owner performs5 focused retest steps and reports PASS/FAIL; Developer reconciles resulting local writes. No automatic Promotion, activation or next task. |
| Parking Lot Authorization | Task10 only; items1–8 remain unselected,9completed. No automatic next task. |

Private evidence/runbook: C:/Users/aacha/AppData/Local/Temp/task10-calendar-uat-20260922 .
Accounts remain only in ACCOUNTS-LOCAL-ONLY.txt and loopback controller.
[Dated delivery evidence](DEVELOPMENT_TODO.md#task10-calendar-delivery-2026-09-24).
