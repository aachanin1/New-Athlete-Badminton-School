...
Local correction and verification complete; replacement publication and exact staged acceptance gates follow under Owner authorization.

### Current Project Matrix

| Field | Current value |
| --- | --- |
| Active Task / Intended Behavior | Task10 — 22 September Owner UAT corrections: child-first full-month Kids calendar, independent family/legacy pagination, accurate Family Private post-Store warning. |
| Task Status / READY / Task Done | DEVELOPING / No, replacement publication and staged verification remain / No. |
| Owner Decision / Scope | Owner22September approved audit through normal commit/push, staged Production without customer aliases and focused Owner retest. No Promotion, activation or remote business write. |
| Changed Paths / Scope Expansion / Breach | Functional4 / Tests3 / Docs3 =10, including two explicitly approved new calendar files. Config/Dependencies/Migrations0. Expansion0; breach0 this round. Historical packaging/source-exposure breach remains recorded. |
| Protected Policy / Blast Radius | Makeup dialog/list and Family Schedule warning presentation; Adult/Private shares calendar presentation only. API/RPC/source selection, N/M/D/quota/identity, Family atomicity, Reschedule>=12h, Wallet>48h, same-month/ten-month, pricing/payment/attendance/payroll remain unchanged. /admin/schedules unchanged. |
| Branch / Upstream | spike/next-major-security-upgrade / origin/spike/next-major-security-upgrade. |
| Local HEAD / Remote HEAD / Ahead-Behind | 2a1ac266d1f513db43caa677438184b93c63abc0 / same live remote /0/0 at pre-publication audit. The new candidate is still in the worktree at this record. |
| Index / Worktree | Fresh24September: exact10 approved paths staged, no unrelated or untracked source changes. Carried-over Docs3 retained; complete staged diff and EOL/content proof reviewed before commit. |
| Source Complete / Current Source / Pushed Source | Yes for three local corrections / tested working candidate based on2a1ac266 / prior2a1ac266. Replacement source is not yet pushed at this record. |
| Tests Passed / Fresh Checks | Final-byte Task10 79/79 (44.8min), Booking23/23, Makeup5/5; Wallet45/45, Admin state39/39, retrospective38/38. No skipped/flaky cases in the three Playwright reports. Counts are separate suites with overlapping coverage, not a summed unique total. TypeScript/lint/mojibake and filtered Next build passed. |
| Fresh Local Preflight | 12 real-build UI/DB checks passed: family17 pagination15/2 versus Adult1; family-only/legacy-only/mixed/empty; Thai calendar and390px; actual attendee/template/source, used1/remaining4 after reload; whole-unit Family Store/Redeem2members/1credit/1target; real ineligible unit still warns/denies. Owner rows and financial invariants unchanged; page errors0, console errors0, HTTP5xx0. |
| Retained Evidence / Owner UAT Baseline | Owner22September reported old2a1ac266 local transactions and staged read-only navigation passed with three findings. These are baseline evidence, not acceptance of new bytes. Prior148/A1/A2/18–19September results remain historical and are not counted as new runs. |
| Committed / Pushed | Replacement No / No at this pre-publication record; prior2a1ac266 Yes/Yes. Authorized normal commit/push follows passed local gates. |
| Local Build / Inputs | Next16.3.3 filtered candidate build NXCoIyXhfjsD-z-U0SxRC,363 actual CLI-filtered inputs, runtime hashes matched. Local build/environment is distinct from remote staged. New helper/source files included; forbidden paths and audited synthetic literals absent. |
| Config / Protected Hashes | 483 tracked Gate0 files outside allowlist unchanged. Package/lock/config/AGENTS/API/RPC/migration bytes frozen. Working raw hashes and index/commit LF hashes will be recorded separately; no Git config change. |
| Preview / Staged Artifact / Deployed Source | Replacement not yet created. Prior staged dpl_4q42QfNPuxYCT3Ho4e7QssSw7Crb /2a1ac266 remains baseline only: https://new-athlete-badminton-school-l3tfhzk9q-aachanin1s-projects.vercel.app . It does not contain the new corrections. |
| Production / Rollback / Checks | Fresh22September11:33:18–11:33:26UTC: four customer aliases still dpl_Gwx4XuRureXfQh4vhCUxPEtHECBa /99b70fe373bfaa14424e2163136719024e5f0b0b READY; rollback available; healthJSON200/ok. Actual productionBranch main, spike push creates Preview. No routing/settings change. |
| Owner UAT / Production UAT / Controlled Write UAT | Old-version Owner round completed with findings; replacement Owner retest Pending / no new Production business UAT / Developer-owned synthetic local writes only. Developer preflight is not OwnerPASS. |
| Promotion / Deployment | No Promotion or activation. Replacement automatic Preview and staged Production are the next authorized gates, not completed facts at this record. |
| Migration Source / Migration Applied | Definitions unchanged. M1–M5 applied earlier; fresh SELECT11:33:55UTC confirms all5 versions. No remote apply/repair. Existing migrations run through the unchanged harness only in the new disposable. |
| Remote Feature Enabled / Activation / Scheduler | Fresh22September11:33:55UTC: never_activated/rev0/effective_at+artifactNULL/allflagsfalse; one task10-expire-unpaid-bookings-v1 inactive; activation events0/worker runs0. No remote controls or cron write. |
| Local UAT / Fixture State | New candidate http://127.0.0.1:3050/__uat ->Next3051, Task10Calendar20260922 API58321/DB58322 with physical container/volume/workdir/network/AuthRESTStorage checks. Developer cases used separately; Owner multiple-child/single-child quota0used and Family unit remain untouched. Original3040/3041 and databases54321/55321/56321/57321 preserved. |
| Local Controls / Clock | New disposable active/rev1/pricing+makeuptrue/expiryfalse; croninactive, native business clock. Browser/Auth/Node real time; no global Date override. Use a separate private browser session for the new local site to avoid sharing old local Auth cookies. |
| Owner Backend Reconciliation | Fresh SELECT09:43:20UTC confirms old Owner Makeup1/remaining4 at25September17–19; KidsWallet20Oct->1Oct with sibling unchanged; FamilyPrivate2exactmembers/one redeemed credit/one12Oct target; legacy expiry31Oct retained; History cancelled0active and verified1active/500baht. Selected complete rows unchanged at repeat11:46:59UTC. UI attribution is Owner-reported; full pre-Owner financial baseline Unknown. |
| Allowlisted / Permissions / Environment | No remote allowlist/permission/Auth/environment/secret/protection changes. Only verified local process bindings and synthetic fixture roles; private accounts outside Git/deployment. |
| Production Active / Production Data Changed / Data Repaired | Task10 remains OFF at fresh read. No Developer Production business or financial write/repair. Earlier applied schema/bootstrap is retained; unrelated customer traffic not audited. |
| Customer / Financial Impact | No customer routing or live financial action. Fresh synthetic identity/quota/credit and payment/coupon/allocation/finance invariants pass. No claim that all historical customer financial data was audited. |
| Failures / Bounded Corrections | Baseline Family warning reproduced after successful Store. Initial lint unused-import warning fixed. Unchanged retrospective guard rejected a parent-component timer; one correction moved only the presentation clock into the approved new component, retaining the guard and mutation locks. Final suites rerun after that source change. One synthetic legacy fixture INSERT was correctly rejected by lifecycle guard; full rollback proven and only that Developer read case resumed under the existing inert-fixture transaction pattern, with Owner rows/controls unchanged. |
| Logs / Security Limitations | Final dev runs: Task10 stream-close0 and one reset-period fetch failure; Booking stream-close3, Makeup stream-close4, digest3299920112 near simulated failure/refresh cases. Exact request attribution Unknown; not claimed harmless. Final Production-build local preflight server log has no new error, browser error0/5xx0 in its bounded window. Historical ERR_ABORTED, packaging/source exposure and credential-validity Unknown retained; no whole-system security PASS. |
| Cleanup / Serving | Final regression teardown proved empty owned test rows before retest preparation; retest fixtures intentionally remain, not residue0. Fresh24September finds no3040/3041/3050/3051 listener; stop causeUnknown. New58321 physical container/volume/AuthRESTStorage bindings verified; no reset/reseed. Committed-source local runtime restart and current fixture freshness follow publication; old data preserved. |
| Documentation Drift | Superseded19September OwnerPending/unused-fixture claims with Owner22September report and fresh reconciliation. Carried Docs3/history retained; current matrix is authoritative, TODO is next action, DEV is dated history. |
| Blocker / Remaining Work / Next Gate | Local correction and verification complete. Remaining: exact commit/push, Preview and staged packaging/smoke/logs, new school-session read-only verification, committed-source local handoff. Chrome preparation could not observe a minimized window; later authenticated browser access remains unverified, not an application failure claim. |
| Parking Lot Authorization | Task10 only; items1–8 remain unselected,9completed. No automatic next task. |

Evidence: C:/Users/aacha/AppData/Local/Temp/task10-calendar-uat-20260922 . Private accounts/helpers remain outside repository.
[Dated corrective evidence](DEVELOPMENT_TODO.md#task10-calendar-owner-uat-2026-09-22).
