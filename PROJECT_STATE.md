...
## Current State — Task10 exact artifact promoted; policies OFF

**Promotion with Task10 OFF is Complete after this documentation publication.** Customer aliases serve the exact accepted artifact without rebuild. Owner acceptance PASS remains PM-operated QA certified by Owner, not Owner-click attribution or Production business UAT. Task10 controls stay OFF and scheduler inactive; activation is not authorized. **Task Done: No.**

### Current Project Matrix

| Field | Current value |
| --- | --- |
| Active Task / Intended Behavior | Task10 — exact accepted-artifact Promotion with Task10 OFF; release postchecks and documentation closeout. |
| Task Status / READY / Owner Acceptance / Task Done | DEVELOPING overall; Promotion with Task10 OFF Complete after documentation publication. Corrective Owner acceptance PASS remains valid for the accepted bytes; READY/UAT gate already completed. Task Done No; activation is a separate next gate. |
| Owner Decision / Actor | Owner explicitly authorized exact Promotion of dpl_5bJmN6piCPmThycQEBSr9Rvqj2MF, read-only pre/postchecks and normal Docs3 commit/push, with Task10 OFF and no activation. Developer operated this release. PM temporary local3transaction exception and Owner-certified QA remain historical, not permanent PM authority. |
| Changed Paths / Scope Expansion / Breach | This round Functional0 / Tests0 / Docs3 / Config0 / Dependencies0 / Migrations0. Exact paths PROJECT_STATE.md, TODO-CODEX.md, DEVELOPMENT_TODO.md. Expansion0/breach0. Accepted corrective retained Functional4/Tests3/Docs3; historical packaging/source-exposure breach remains recorded. |
| Blast Radius / Protected Behavior | Customer aliases now serve the exact accepted application artifact. No application/test/API/RPC/business-rule edit; Task10 activation-gated policies remain OFF. Family atomicity, identity, N/M/D/quota, Reschedule>=12h, Wallet>48h, same-month/ten-month, pricing/payment/attendance/payroll and /admin/schedules source unchanged. |
| Branch / Upstream | spike/next-major-security-upgrade / origin/spike/next-major-security-upgrade. |
| Local HEAD / Remote HEAD / Ahead-Behind | Fresh Gate0: both cae96a2dfe3ec83ff2684355ea6f5f793da26610, live remote verified,0/0. The containing Docs-only closeout commit is its successor; final HEAD/live remote/index/worktree are recorded in promotion-off-20260924/publication.json and final report. Application SHA remains fixed independently. |
| Index / Worktree / Documentation Commit | Gate0 indexempty/worktreeclean. Only Docs3 changed for this closeout; complete staged diff and normal publication verified separately. This documentation successor does not replace the promoted artifact. |
| Source Complete / Current Source / Pushed Source | Yes /1fba7bab987e8455824889563604063813e08855 /same. All490 non-doc commit files unchanged from accepted source;483 original protected raw hashes plus7 corrective source/test hashes verified. |
| Committed / Pushed | Application Yes/Yes; prior Docs cae96a2d Yes/Yes; this containing documentation successor is published normally with final live proof in promotion-off-20260924/publication.json. |
| Tests Passed / Retained22September | Yes: Task10 79/79, Booking23/23, Makeup5/5, Wallet45/45, Admin state39/39, retrospective38/38; TypeScript/lint/mojibake/build retained on identical application/test/config bytes. No business-suite rerun or rebuild this release round; overlapping suites are not summed. |
| PM QA / Owner Acceptance Evidence | PM QA0–6 PASS, local3POST200 and9reconciliation assertions, snapshots03:21:56–03:34:35UTC/report03:37UTC. Owner's later explicit current command certifies PASS. The PM report's former Pending wording is retained as dated history, not current acceptance. |
| Fresh Developer Verification | Release Gate0 confirms490non-doc Git paths,483protected raw hashes plus7corrective hashes,493local-build inputs and fixed delivery/post-UAT references unchanged. Vercel identity/routing/rollback,88M1–M5function-body hashes,pre/postcontrols,exactPromotion,25HTTPchecks including21assets,10browser read-only checks and scopedlogs passed. Prior post-UAT SELECT reconciliation remains retained, not rerun. |
| Local Build / Serving | PXUCkAh-yTw4DI3U0jEs3, same1fbaSHA/493input hashes verified fresh. Last serving proof from post-UAT closeout24September04:21UTC at3050controller->3051Next retained; no restart/stop/cleanup/rebuild or new local business action in this Promotion round. Local and Production are separate builds/environments. |
| Local Target / Bindings | Retained post-UAT24September04:12UTC verification: Task10Calendar20260922 API58321/DB58322; exact container33aff73a56af3d3f59a1b2127cde0f73603eff052d0ea7145017b4edc99d0301, ownedvolume/workdir/network and actual Auth/REST/StorageDBbindings confirmed; transaction_read_only=on. No local DB read/write this release round. |
| Local Data After QA — Makeup | Calendar Owner used1/remaining4, exact25September17:00–19:00Localhost destination and request/use/source links match. Attending child differs from source child within the same family; committed evidence N20/D2/M2/quota5. Calendar Single Owner remains unused and its sessions unchanged. |
| Local Data After QA — Family | Ownerwallet11October05:01–06:01 Store created one active credit with2exactmembers (preserved intermediate snapshot). Same credit now redeemed to12October05:01–06:01,2exacttarget sessions/one canonicalslot; no duplicate/orphan credit, identity preserved. These Owner-labeled cases were used by PM, not fresh/unused now. |
| Canonical / Financial Reconciliation | Retained post-UAT24September04:12UTC read: all3new sessions match active exact template, branch, course, Bangkok weekday and time; original bookings, protected other Family hour and scoped financial digest unchanged from PMbefore through that read. Scope is Family booking plus disposable payments/coupon_usages/progressive_payment_allocations/finance_expenses, not whole-system accounting certification. |
| Preview / Deployed Source | Customer Production now serves1fba7bab987e8455824889563604063813e08855 through the accepted artifact. Original source Preview dpl_2gzzT7vfHgwpeFTwmYkQ2kA7oWKL remains separate. Automatic Docs Git Previews, including this publication if triggered, are recorded separately and never replace the accepted/promoted artifact. |
| Accepted Staged Artifact / Deployment ID | Accepted Production-target artifact dpl_5bJmN6piCPmThycQEBSr9Rvqj2MF /1fba7bab987e8455824889563604063813e08855 is now promoted and READY. Original URL https://new-athlete-badminton-school-l3qograeq-aachanin1s-projects.vercel.app remains continuous. Same363input proof/219outputs/build timestamps; no rebuild/redeploy/replacement. |
| Local QA / Staged QA / Production UAT | Owner-certified PM local functional QA and staged school-SuperAdmin read-only QA remain accepted separately. Fresh Developer customer-Production school-SuperAdmin read-only Makeup checks passed both tabs/search/month/pagination/reload. Production business UAT Passed: No; read-only smoke does not certify business writes. |
| Controlled Write UAT | Retained PM three specifically authorized synthetic local transactions only. Developer this round0local/0Productionbusinesswrites/0replays. No Production controlled-write UAT. |
| Promotion / Production Routing / Checks | Complete: one CLI59.11.2 Promotion invocation24September07:03:59.546–07:04:05.393UTC (14:03:59–14:04:05Bangkok),exit0. All4approved customeraliases now point to accepted dpl_5bJmN6piCPmThycQEBSr9Rvqj2MF; pre/post/final routing verified. Rollback dpl_Gwx4XuRureXfQh4vhCUxPEtHECBa /99b70fe373bfaa14424e2163136719024e5f0b0b READY and pre-release health200. Health/home/login/assets passed; unauthenticated Makeup307login; real SuperAdmin reads passed. Deploymenterror/fatal/5xxqueries07:03:59–07:10:24.321UTC found no matches; bounded evidence, not whole-system PASS. |
| Migration Source / Migration Applied | M1–M5 previously applied, confirmed fresh before/after release.88currentfunction-body hashes match last definitions in accepted migrations (CRLF/outer whitespace normalized); no function invoked for this definition check. No migration/apply/repair. |
| Remote Feature Enabled / Activation / Scheduler | Fresh SELECT24September06:59:51.797899UTC before,07:05:08.193394UTC after and07:10:27.885844UTC final: never_activated/rev0/effective_at+artifactNULL/pricing+makeup+expiryfalse; exactlyoneinactivecron/events0/runs0 unchanged. ProductionSupabase binding tvnhholicwjtxdhlxfqs /NewAthleteBadmintonSchool confirmed. No activation/pause/resume/worker/control/cron write. |
| Local Controls / Clock | Retained post-UAT read matches PMbefore/final: active/rev1/pricing+makeuptrue/expiryfalse/croninactive. Native policy-clock definition retained; no clock mutation, Auth/browser/Node real time. No fixture date/entitlement extension. |
| Allowlisted / Permissions / Environment | No changes to remote allowlists, permissions, Auth, environment, secrets or protection. Synthetic accounts remain private and local-only. |
| Production Active / Production Data Changed / Data Repaired | Accepted application is customer-Production active; Task10 activation-gated policies remain NOT ACTIVE. No Developer Production business/data write or repair; alias routing is the sole release mutation. No claim that all tables stayed unchanged while real customers use the system. Prior schema/bootstrap history retained. |
| Customer Impact / Financial Impact | Customers receive accepted application1fba after Promotion, including corrective presentation. No Developer booking/payment/Wallet/Makeup/financial transaction. Prior scoped local financial invariants retained; customer traffic and whole-system accounting were not audited. |
| Cleanup / Preservation | Local UAT/runtime, all used/unused fixtures and PM/Owner/Developer/failed evidence preserved. No reset/reseed/replay/repair/delete/cleanup/stop; all old local databases preserved. Used Calendar Owner/Ownerwallet remain used; Calendar Single Owner unused per accepted reconciliation. |
| Unknowns / Limitations | Historical stream-close/ERR_ABORTED attribution, credential validity and exposure remain Unknown. Bounded release logs do not certify overall security or all customer traffic. Production browser read-only action evidence is not a complete network-write audit. Two accessibility footer-coordinate errors were resolved with a fresh screenshot through the same tool; no safety denial/bypass. Old complete pre-Owner financial baseline remains unavailable. |
| Documentation Drift / Root Cause | Corrected for this release: prior current state correctly described pre-Promotion and is now superseded by explicit authorization and measured routing. Owner acceptance PASS preserved; no unused-fixture/retest-pending regression. Source/artifact/docs identity and OFF/active distinctions kept separate. |
| Blocker / Remaining Work / Next Gate | No release blocker; Promotion with Task10 OFF and documentation publication complete. Next decision: separately authorize preparing/reviewing a fresh exact-row activation manifest with actual data/control/scheduler effects and pause/rollback plan, then explicit activation approval. No activation work or other task starts automatically. |
| Task10 Overall / Parking Lot Authorization | Task Done No. Task10 only; ParkingLot1–8 unselected/9completed; no next task or permanent PM-testing authority introduced. |

Private release evidence: C:/Users/aacha/AppData/Local/Temp/task10-calendar-uat-20260922/promotion-off-20260924 .
Original PM and post-UAT Developer evidence remain unchanged in ../pm-qa-20260924 and ../post-uat-dev-20260924 .
[Dated Promotion record and next gate](DEVELOPMENT_TODO.md#task10-promotion-off-2026-09-24).
